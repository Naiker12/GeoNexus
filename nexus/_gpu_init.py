...
if already_imported:
    ...
    warnings.warn(
        ...
        f"Please restructure your imports with 'import nexus' at the top of your file.",
        stacklevel = 2,
    )
        ...
        if not torch.cuda.is_available():
            ...
            try:
                ...
                warnings.warn(
                    ...
                    "You need to run in your terminal `sudo ldconfig /usr/lib64-nvidia` yourself, then import nexus.\n"
