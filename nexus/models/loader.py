...
from ._utils import (
    ...
    # `from nexus.models.loader import DISABLE_SDPA_MODEL_NAMES` keep working and so
...
# `from nexus.models.loader import FORCE_FLOAT32` keep working. The fallback
    ...
    def from_pretrained(
        ...
        **kwargs,
        ...
        # Gemma 3
            ...
            from nexus.kernels.utils import is_rdna
