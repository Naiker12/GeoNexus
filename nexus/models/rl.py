...
try:
    from nexus.models._utils import _unsloth_reset_stray_compile_cache
except Exception:
...
try:
    from nexus.models.rl_config_compat import filter_config_init_kwargs as _unsloth_filter_config_init_kwargs
except Exception:
        ...
        if trainer_file == "sft_trainer":
            ...
            if "`max_length` is not enforced" in old_RLTrainer_source:
                max_length_check += (
                    ...
                    "            except ImportError:\n"
                    "                from nexus.dataset_num_proc import get_dataset_num_proc as _unsloth_get_nproc\n"
