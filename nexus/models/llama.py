...
from nexus.models._attn_mask_compat import (
        ...
        **kwargs,
        ...
        try:
            if num_labels is not None:
                ...
                from nexus.models.vision import _attach_bnb_multidevice_hooks
        ...
        inner_training_loop = inner_training_loop.replace(
            ...
            "self.accelerator.free_memory()\n"
            "    try:\n"
            "        from nexus.models._utils import _unsloth_reset_stray_compile_cache as _unsloth_reset_cc\n"
