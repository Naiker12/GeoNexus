from nexus.registry.registry import ModelInfo, ModelMeta, QuantType, _register_models
...
def _list_deepseek_r1_distill_models():
    from nexus.utils.hf_hub import ModelInfo as HfModelInfo
    from nexus.utils.hf_hub import list_models
...
if __name__ == "__main__":
    from nexus.registry.registry import MODEL_REGISTRY, _check_model_info
