...
from spartan_agent_cli._system_dir_guard import check_working_directory as _check_working_directory
...
from spartan_agent_cli.commands.train import train
from spartan_agent_cli.commands.inference import inference
from spartan_agent_cli.commands.chat import chat
from spartan_agent_cli.commands.start import start_app
from spartan_agent_cli.commands.export import export, list_checkpoints
from spartan_agent_cli.commands.studio import (
    run as studio_run,
    studio_app,
...
# third-party scripts that import spartan_agent_cli keep their argv intact.
if _is_entry_point:
