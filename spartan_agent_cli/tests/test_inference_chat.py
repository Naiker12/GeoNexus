...
import spartan_agent_cli.commands.chat as chatmod
from spartan_agent_cli._inference import (
    ChatBackend,
    HttpChatBackend,
    collect_stream,
...
def _inference_app():
    from spartan_agent_cli.commands.inference import inference
...
def test_find_studio_server_none_when_not_running(monkeypatch):
    ...
    from spartan_agent_cli import _inference
...
def test_padded_body_helper_passes_a_real_payload_through():
    from spartan_agent_cli._inference import require_completed_padded_body
...
def test_deferred_error_helper_passes_a_normal_body_through():
    from spartan_agent_cli._inference import raise_for_deferred_error
...
def _stub_studio_gguf_load(monkeypatch):
    ...
    import spartan_agent_cli._inference as inference
...
def test_inference_forwards_gguf_runtime_options_to_loader(monkeypatch):
    from spartan_agent_cli.commands import inference as infermod
...
def test_inference_local_handles_stream(monkeypatch, chunk_kind, expected_exit):
    from spartan_agent_cli.commands import inference as infermod
    from spartan_agent_cli._inference import ensure_studio_backend_path
