...
import type { Artifact, FileNode, WorkspaceState } from "./ide-types"
      ...
      <div className="flex-1 flex overflow-hidden relative">
        ...
        <div className="flex-1 flex flex-col min-w-0">
          <div className="flex-1 min-h-0">
            <CodeEditor file={state.selectedFile} theme="dark" />
          </div>
        </div>
        ...
        <div className="w-80 flex-shrink-0 border-l border-border flex flex-col bg-card">
          ...
          <div className="flex-1 overflow-auto">
            {activeSidebar === "artifacts" ? (
              <ArtifactsPanel artifacts={state.artifacts} onViewArtifact={handleViewArtifact} />
            ) : (
