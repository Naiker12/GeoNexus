            ...
            return (
              ...
              >
                ...
                <div className="min-w-0 flex-1">
                  ...
                  <p className="truncate text-[0.65rem] text-muted-foreground">{entry.path}</p>
                  <p className="text-[0.6rem] text-muted-foreground flex items-center gap-1 mt-0.5">
                    {entry.status === "Started" && <Clock className="size-2.5 animate-pulse" />}
                    {entry.status === "Completed" && <CheckCircle className="size-2.5" />}
                    {entry.status === "Failed" && <XCircle className="size-2.5" />}
