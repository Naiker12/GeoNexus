...
// Datos de ejemplo
export const exampleSteps: TimelineStep[] = [
  {
    id: 't1',
    agent: 'planner',
    ...
    finishedAt: Date.now() - 17300,
    items: [
      { name: 'Stack: React + Tailwind + Zustand', status: 'done' },
    ],
  },
  {
    id: 't2',
    ...
    status: 'done',
    startedAt: Date.now() - 17300,
    finishedAt: Date.now() - 16000,
    items: [
      { name: '~/projects/inventario-app', status: 'done' },
    ],
  },
  {
    id: 't3',
    ...
    finishedAt: Date.now() - 8500,
    items: [
      { name: 'react@18.3', status: 'done' },
      { name: 'tailwindcss@3.4', status: 'done' },
      { name: 'zustand@4.5', status: 'done' },
      { name: '@tauri-apps/api@2.0', status: 'done' },
      { name: 'lucide-react@0.383', status: 'done' },
    ],
  },
  {
    id: 't4',
    agent: 'coding',
    label: 'Generando componentes UI',
    status: 'running',
    startedAt: Date.now() - 8500,
    items: [
      { name: 'App.tsx', status: 'done' },
      { name: 'components/Layout.tsx', status: 'done' },
      { name: 'components/ProductTable.tsx', status: 'done' },
      { name: 'components/AddProductModal.tsx', status: 'pending' },
      { name: 'store/inventory.ts', status: 'pending' },
    ],
  },
  {
    id: 't5',
...
export const exampleStats: GenerationStats = {
  filesCreated: 12,
  linesOfCode: 847,
  dependenciesAdded: 5,
  totalTimeSeconds: 17.3,
};
