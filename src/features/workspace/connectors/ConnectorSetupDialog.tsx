  ...
  const handleLocalConnect = async () => {
    if (!folderPath.trim()) {
      toast({
        ...
        description: "Debes elegir una carpeta local primero.",
        variant: "warning",
      })
      return
    }
    ...
    try {
      ...
      toast({
        ...
        description: `${provider.name} configurado en ${folderPath}`,
        variant: "success",
      })
    } catch (err) {
      dismiss(loadingId)
  ...
  const handleCloudOAuth = async () => {
    ...
    try {
      ...
      toast({
        ...
        description: `Completa el inicio de sesion de ${provider.name} en el navegador.`,
        variant: "success",
      })
    } catch (err) {
            ...
            {isCloud ? (
              <div className="flex flex-col items-center gap-3 rounded-lg border border-border bg-muted/20 p-6">
                ...
                <p className="text-center text-sm text-muted-foreground">
                  Conecta con tu cuenta de <strong>{provider.name}</strong>. Te enviaremos al
                  navegador.
                </p>
                <Button
                  size="lg"
              ...
              <div className="flex flex-col gap-2">
                ...
                <div className="flex justify-end gap-2 pt-2">
                  ...
                  <Button
                    ...
                    disabled={connecting || connected || !folderPath.trim()}
                  >
                    {connecting ? (
    ...
    <div className="grid gap-3">
      ...
      <div className="rounded-lg border border-border bg-muted/40 p-3">
        ...
        <p className="mt-2 text-sm leading-5 text-muted-foreground">
          Connector Manager recibe la solicitud, valida permisos, crea el conector, envia archivos
          al indexador, genera embeddings en ChromaDB y actualiza el Knowledge Graph para Geo
          Agents.
        </p>
