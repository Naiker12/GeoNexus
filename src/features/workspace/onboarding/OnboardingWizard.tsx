        ...
        return (
          <div className="flex flex-col items-center text-center px-6 py-8">
            ...
            <p className="text-sm text-muted-foreground max-w-sm mb-4">
              Pick a folder that will contain your projects. GeoNexus will have access to this
              directory.
            </p>
      ...
      case "done":
        return (
          <div className="flex flex-col items-center text-center px-6 py-8">
            ...
            <p className="text-sm text-muted-foreground max-w-sm mb-6">
              Your workspace folder has been configured. You can always add more paths or change
