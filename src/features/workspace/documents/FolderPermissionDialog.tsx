        ...
        <div className="grid gap-3 p-4">
          <ul className="grid gap-2 text-xs">
            {[
              ...
              <li
                key={title}
                className="flex items-start gap-2 rounded-md border border-border bg-background/60 px-2.5 py-2"
              >
          ...
          <p className="text-xs text-muted-foreground">
            No se modificaran tus archivos originales. Los chunks y embeddings se almacenan en la
            base de datos local.
          </p>
