    ...
    <svg viewBox="0 0 420 430" aria-hidden="true" className={cn("size-8", className)}>
      <g transform="translate(14,10)">
        ...
        <ellipse
          ...
          fill={b("#fff", "#333")}
          opacity="0.85"
          transform="rotate(-20,211,103)"
        />
        {/* Smile */}
        <path
          d="M138 152 Q172 174 206 152"
          stroke={b("#111", "#ccc")}
          strokeWidth="5.5"
          fill="none"
          strokeLinecap="round"
        ...
        <g transform="translate(295,198) rotate(-10)">
          <rect
            ...
            height="100"
            rx="14"
            fill="var(--primary, #00BFFF)"
            opacity="0.85"
            stroke="var(--primary, #00BFFF)"
            strokeWidth="3.5"
          />
          ...
          <path
            d="M95 60 L88 78 L92 74 L95 82 L98 74 L102 78 Z"
            fill="#EE1144"
            stroke="#fff"
            strokeWidth="1"
          />
...
function FullLogoSvg({ className, dark }: { className?: string; dark?: boolean }) {
  ...
  return (
    <svg
      viewBox="0 0 1860 430"
      aria-hidden="true"
      className={cn("w-auto h-8 sm:h-10", className)}
