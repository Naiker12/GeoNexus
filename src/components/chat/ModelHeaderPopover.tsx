import { BotIcon, CheckIcon, PlusIcon, SearchIcon } from "lucide-react"
        ...
        >
          <span
            className={cn(
              ...
              hasModel ? "bg-emerald-500 animate-pulse" : "bg-amber-400"
            )}
          />
            ...
            filtered.map((entry) => {
              ...
              return (
                ...
                >
                  ...
                  <span className="min-w-0 flex-1 truncate">{entry.modelId}</span>
