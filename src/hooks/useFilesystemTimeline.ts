import { type BusEvent, subscribeToAllBusEvents } from "@/api/events"
import type { TimelineEntry } from "@/api/filesystem-timeline"
import { useCallback, useEffect, useRef, useState } from "react"

const FS_ACTIONS = new Set([
  "fs_listDirectories_started",
  "fs_listDirectories_completed",
  "fs_listDirectories_failed",
  "fs_listFiles_started",
  "fs_listFiles_completed",
  "fs_listFiles_failed",
  "fs_searchFiles_started",
  "fs_searchFiles_completed",
  "fs_searchFiles_failed",
  "fs_createFolder_started",
  "fs_createFolder_completed",
  "fs_createFolder_failed",
  "fs_createFile_started",
  "fs_createFile_completed",
  "fs_createFile_failed",
  "fs_updateFile_started",
  "fs_updateFile_completed",
  "fs_updateFile_failed",
  "fs_deleteFile_started",
  "fs_deleteFile_completed",
  "fs_deleteFile_failed",
  "fs_moveFile_started",
  "fs_moveFile_completed",
  "fs_moveFile_failed",
  "fs_copyFile_started",
  "fs_copyFile_completed",
  "fs_copyFile_failed",
  "fs_detectFramework_started",
  "fs_detectFramework_completed",
  "fs_detectFramework_failed",
  "fs_analyzeProject_started",
  "fs_analyzeProject_completed",
  "fs_analyzeProject_failed",
  "fs_createProject_started",
  "fs_createProject_completed",
  "fs_createProject_failed",
])
      ...
      setEntries((prev) => {
        ...
        if (entry.status !== "Started") {
          const idx = prev.findIndex(
            (e) =>
              e.tool_name === entry.tool_name && e.path === entry.path && e.status === "Started"
          )
          if (idx >= 0) {
            const next = [...prev]
            next[idx] = entry
