...
from ._utils import (
    ...
    # `from spartan_agent.models.loader import DISABLE_SDPA_MODEL_NAMES` keep working and so
...
# `from spartan_agent.models.loader import FORCE_FLOAT32` keep working. The fallback
    ...
    def from_pretrained(
        ...
        **kwargs,
        ...
        # Gemma 3
            ...
            from spartan_agent.kernels.utils import is_rdna
