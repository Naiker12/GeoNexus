        ...
        dataset = pack_dataset(
            ...
            **_pack_kwargs,
            ...
            try:
                ...
                from spartan_agent.dataset_num_proc import get_dataset_num_proc as _unsloth_get_dataset_num_proc
...
\g<indent>    from spartan_agent.dataset_num_proc import get_dataset_num_proc as _unsloth_get_dataset_num_proc
...
\g<indent>)""",
            ...
            function = _require_replace(
                ...
                from spartan_agent.dataset_num_proc import map_failure_diagnostics as _unsloth_map_diagnostics
...
RL_PRE_ITEMS["grpo_trainer"].append(
    ...
    "if UNSLOTH_GRPO_PREFIX_GROUPER_ON:\n"
    "    try:\n"
    "        from spartan_agent.utils.prefix_grouper import build_group_layout as _pg_build_layout, prefix_grouper_enabled as _pg_enabled_fn, verify_on as _pg_verify_on, tol_ok as _pg_tol_ok, TOL_KILL as _PG_TOL_KILL\n"
    "    except Exception:\n"
    "        UNSLOTH_GRPO_PREFIX_GROUPER_ON = False\n"
)
