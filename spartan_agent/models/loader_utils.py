...
from spartan_agent.models._utils import TorchAOConfig
...
def _get_torchao_fp8_config(fp8_mode):
    # Lazy import so a broken optional vLLM install doesn't break `import spartan_agent`.
...
# the Studio training worker matches (studio/spartan_backend/core/training/worker.py, #7845):
