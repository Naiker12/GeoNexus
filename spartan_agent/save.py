...
def _compressed_ignore_patterns(model):
    ...
    """
    try:
        from spartan_agent._compressed_quantize import compressed_ignore_patterns
...
# its own bitsandbytes import optional would otherwise break `import spartan_agent` on a
