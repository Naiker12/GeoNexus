...
from nexus_cli._system_dir_guard import check_working_directory as _check_working_directory
...
from nexus_cli.commands.train import train
from nexus_cli.commands.inference import inference
from nexus_cli.commands.chat import chat
from nexus_cli.commands.start import start_app
from nexus_cli.commands.export import export, list_checkpoints
from nexus_cli.commands.studio import (
    run as studio_run,
    studio_app,
...
# third-party scripts that import nexus_cli keep their argv intact.
if _is_entry_point:
