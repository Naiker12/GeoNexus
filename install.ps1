...
# beforehand (SPARTAN_NO_TORCH, SPARTAN_SKIP_AUTOSTART, SPARTAN_PYTHON, SPARTAN_STUDIO_HOME); a
...
function Install-UnslothStudio { Install-SpartanStudio @args }

Install-SpartanStudio @args
