...
// Copyright 2026-present the Spartan AI Inc. team. All rights reserved.
...
export const ja = {
  ...
  settings: {
    ...
    dialog: {
      title: "設定",
      description: "Spartan の環境設定を管理します。",
    ...
    debugging: {
      ...
      empty: "まだ何も記録されていません。",
      disabled: "ファイルへのログ出力は無効です (SPARTAN_STUDIO_NO_FILE_LOG=1)。",
    ...
    voice: {
      ...
      dictation: {
        ...
        sttLoaded: "読み込み済み",
        sttUnavailable:
          "このサーバーにはインストールされていません。ローカルの音声入力を有効にするには `Spartan Studio update` を実行してください。",
        sttRetry: "再試行",
        ...
        micAccessBlocked:
          "マイクへのアクセスがブロックされました。この Spartan のページでマイクへのアクセスを許可してから、もう一度お試しください。",
    ...
    general: {
      ...
      password: "パスワード",
      passwordDescription: "この Spartan アカウントのパスワードを変更します。",
      passwordDialog: {
        trigger: "パスワード変更",
        title: "パスワード変更",
        ...
        setDescription: "リモートのブラウザーが Spartan としてサインインするためのパスワード（最低 {minLength} 文字）を選んでください。Spartan デスクトップアプリは引き続き自動でサインインします。",
        setSubmit: "パスワードを設定",
        setting: "設定中...",
      ...
      helperLlm: {
        ...
        disabledByEnv: "バックエンド環境の SPARTAN_HELPER_MODEL_DISABLE によって無効化されています。",
      ...
      modelAutoSwitch: {
        ...
        idleActiveViaEnv: "アイドル時の自動アンロードは SPARTAN_MODEL_IDLE_TTL 環境変数によって有効になっています。",
      ...
      startup: {
        sectionTitle: "起動",
        launchAtLogin: "ログイン時に Spartan を起動",
        launchAtLoginDescription:
          "ログイン時に Spartan をバックグラウンドで起動します。開くまでメニューバーまたはシステムトレイに常駐します。",

        closeToTray: "システムトレイに格納して閉じる",
        closeToTrayDescription:
          "メインウィンドウを閉じても、Spartan とサーバーをバックグラウンドで実行し続けます。",
      ...
      resetPreferences: {
        ...
        confirmDescription: "ローカル限定の設定を消去し、Spartan を再読み込みします。チャット、APIアクセス、DBに保存された設定は保持されます。",
      ...
      permissions: {
        ...
        bypassLabel: "ツールの権限",
        bypassDescription:
          "チャットのツール呼び出し (ターミナル、python、ウェブ、MCP) を実行する前に、Spartan がどのように承認するかを決めます。「Full access」にすると承認とコードサンドボックスが無効になります。",
      },
    },
    profile: {
      title: "プロフィール",
      description: "Spartan 内でのプロフィールの表示方法。",
      changePicture: "プロフィール写真を変更",
      displayName: "表示名",
      nickname: "Spartan での呼び名",
      ...
      stats: {
        title: "あなたの統計",
        subtitle:
          "以下はすべてご自身の履歴から集計しています。収集も Spartan への送信も行いません。",
        retry: "再試行",
        privacyNote:
          "統計は、お使いの Spartan が保持しているチャットとトレーニングの履歴から計算されます。データの収集は行わず、Spartan や第三者への送信も行いません。",
        emptyChats:
    ...
    appearance: {
      title: "外観",
      description: "このデバイスでの Spartan の見た目。",
      theme: {
        title: "テーマ",
        label: "カラー構成",
      ...
      palette: {
        label: "カラーパレット",
        description: "Spartan 全体で使用される配色。ライト・ダーク両対応。",
        standard: "スタンダード",
        classic: "クラシック",
        minimal: "ミニマル",
      },
      custom: {
        ...
        uiFontSize: {
          label: "UI フォントサイズ",
          description: "Spartan UI の基本サイズを調整します。",
        },
        codeFontSize: {
          label: "コードフォントサイズ",
    ...
    resources: {
      title: "システム",
      description: "この Spartan サーバーのハードウェアとストレージを監視します。",
      ...
      llamaBackend: {
        ...
        envLocked: "環境変数 SPARTAN_LLAMA_CPP_BACKEND により {backend} に固定されています。この設定より優先されます。",
        customPath: {
          ...
          automatic: "自動（同梱）",
          bundled: "Spartan がインストールした llama.cpp ランタイムを使用します。",
        ...
        unsupported: {
          ...
          localLink: "llama.cpp は自分でリンクしたローカルディレクトリのため、Spartan は置き換えません。",
    ...
    agents: {
      title: "エージェント",
      description:
        "Spartan start で Claude Code や Codex などのコーディングエージェントをローカルモデルに接続します。",
      intro:
        "は Claude Code、Codex、Hermes、OpenClaw、OpenCode などのエージェントを、Spartan がローカルで提供するモデルに完全オフラインで接続します。OpenAI 互換サーバーを起動し、エージェントの設定ファイルには一切手を加えません。",
      readDocs: "ドキュメントを読む",
      copy: "コピー",
      copied: "コピーしました",
      ...
      modelNote:
        "Codex には llama-server が提供する GGUF モデルが必要です。他のエージェントは transformers ベースのモデルも利用できます。Spartan に読み込み済みのモデルを使うには --model を外してください。",
      subagent: {
        title: "ローカルモデルをサブエージェントとして使う",
        description:
          "{agent} は現在のモデルのまま、選んだタスクだけをこのローカルの Spartan モデルに委任します。",
        ...
        opencodePrompt: "@Spartan このテスト失敗の原因を調べて",
      },
      quickstart: {
        title: "コマンドを組み立てる",
        description:
      ...
      options: {
        title: "主なオプション",
        description:
          "Spartan のフラグが先に解釈され、認識されなかったものはそのままエージェントへ渡されます。",
        model:
          "モデルを選択します。--model がない場合、Spartan start は Studio に読み込み済みのモデルを使用し、未読み込みならエラーになります。",
        contextLength:
        ...
        persist:
          "Spartan が管理するエージェントのストレージを実行間で保持します。",
        asSubagent:
          "親エージェントを現在のモデルのままにし、Spartan をローカルのサブエージェントとして登録します (Claude Code、Codex、OpenCode)。",
        apiKey:
          "Spartan の API キーを指定します (または SPARTAN_API_KEY を設定)。",
        yolo:
      ...
      remote: {
        ...
        description:
          "起動前に次を設定すると、Spartan start を別の場所で動作している Studio に向けられます (--api-key を直接渡すことも可能です):",
      },
      passthrough: {
        title: "エージェントへの引数の受け渡し",
        description:
          "Spartan のフラグより後ろの引数はエージェント自身へ転送されるため、resume のようなネイティブコマンドもそのまま使えます:",
      },
      dryRun: {
        title: "起動せずに内容を確認する",
        description:
    ...
    apiKeys: {
      title: "API",
      description: "OpenAI互換 API を介して Spartan にアクセスします。",
      ...
      secureHttpsHint: "0.0.0.0 ポートは依然としてグローバルにアクセス可能です。完全なセキュリティを確保するには、Spartan を --secure 付きで起動し、この HTTPS リンクのみを公開してください。",
    ...
    about: {
      ...
      dangerZone: "危険ゾーン",
      shutDownStudio: "Spartan をシャットダウン",
      shutDownStudioDescription: "Spartan サーバーを停止し、セッションを終了します。",
      shutDown: "シャットダウン",
      update: {
        title: "Spartan のアップデート",
        commandText: "{label}のテキスト",
        copied: "コピーしました",
        copyCommand: "コマンドをコピー",
        commandCopied: "{label} をコピーしました",
        copyNamedCommand: "{label} をコピー",
        checkingInstall: "Spartan がどのようにインストールされたかを確認中...",
        installIntro: "Spartan のインストールまたはアップデート方法:",
        ...
        restartAfterUpdate: "アップデート後に Spartan を再起動してください。",
        desktopManaged:
        ...
        desktopExternalServer:
          "サーバーを起動したターミナルで `Spartan Studio update` を実行してください。",
        ...
        unknownInstall: "Spartan がどのようにインストールされたか検出できませんでした。インストーラーまたは PyPI インストールの場合は、上記のコマンドを使用してください。",
        localCheckout:
  ...
  studio: {
    ...
    trainingStart: {
      ...
      terminalStart: "> Spartan トレーニングを開始します...",
