...
export const fr = {
  ...
  settings: {
    ...
    dialog: {
      title: "Paramètres",
      description: "Gérez vos préférences Spartan.",
    ...
    debugging: {
      ...
      disabled: "La journalisation dans un fichier est désactivée (SPARTAN_STUDIO_NO_FILE_LOG=1).",
    ...
    voice: {
      ...
      dictation: {
        ...
        sttLoaded: "Chargé",
        sttUnavailable:
          "Non installé sur ce serveur. Exécutez `Spartan Studio update` pour activer la dictée locale.",
        sttRetry: "Réessayer",
        ...
        micAccessBlocked:
          "L'accès au microphone a été bloqué. Autorisez l'accès au microphone pour cette page Spartan, puis réessayez.",
    ...
    general: {
      title: "Général",
      description: "Préférences globales pour Spartan.",
      account: "Compte",
      ...
      passwordDescription:
        "Changez le mot de passe de ce compte Spartan.",
      passwordDialog: {
        ...
        setDescription:
          "Choisissez le mot de passe utilisé par les navigateurs distants pour se connecter avec l'identifiant Spartan (au moins {minLength} caractères). L'application de bureau Spartan continue de se connecter automatiquement.",
      ...
      helperLlm: {
        ...
        disabledByEnv:
          "Désactivé par SPARTAN_HELPER_MODEL_DISABLE dans l'environnement du backend.",
      ...
      modelAutoSwitch: {
        ...
        idleActiveViaEnv: "Actif via SPARTAN_MODEL_IDLE_TTL.",
        loadError:
      ...
      startup: {
        ...
        launchAtLogin: "Lancer Spartan à la connexion",
        launchAtLoginDescription:
          "Démarre Spartan en arrière-plan lorsque vous vous connectez. Il reste dans la barre de menus ou la zone de notification jusqu'à ce que vous l'ouvriez.",

        closeToTray: "Fermer dans la zone de notification",
        closeToTrayDescription:
          "Laisser Spartan et son serveur fonctionner en arrière-plan lorsque vous fermez la fenêtre principale.",
      ...
      resetPreferences: {
        ...
        confirmDescription:
          "Efface les préférences locales uniquement et recharge Spartan. Les discussions, l'accès API et les paramètres stockés en base de données sont conservés.",
      ...
      permissions: {
        ...
        bypassDescription:
          "Comment Spartan approuve les appels d'outils de la discussion (terminal, python, web, MCP) avant leur exécution. Le mode « Full access » désactive les demandes d'approbation et le bac à sable d'exécution du code.",
      },
    },
    profile: {
      title: "Profil",
      description: "Comment votre profil apparaît dans Spartan.",
      changePicture: "Changer la photo de profil",
      displayName: "Nom affiché",
      nickname: "Comment Spartan doit-il vous appeler ?",
      ...
      stats: {
        ...
        subtitle:
          "Tout ce qui suit est calculé à partir de votre propre historique. Rien n'est collecté ni envoyé à Spartan.",
        retry: "Réessayer",
        privacyNote:
          "Les statistiques sont calculées à partir de l'historique des discussions et des entraînements conservé par votre installation Spartan. Rien n'est collecté, et rien n'est envoyé à Spartan ni à un tiers.",
        emptyChats:
    ...
    appearance: {
      title: "Apparence",
      description: "L'apparence d'Spartan sur cet appareil.",
      theme: {
        title: "Thème",
      ...
      palette: {
        label: "Palette",
        description: "Couleurs utilisées dans Spartan, en mode clair et sombre.",
        standard: "Standard",
        classic: "Classique",
        minimal: "Minimale",
      },
      custom: {
        ...
        uiFontSize: {
          ...
          description: "Ajustez la taille de base utilisée pour l'interface Spartan.",
        },
        codeFontSize: {
      ...
      language: {
        ...
        description: "La langue utilisée par Spartan.",
    ...
    resources: {
      title: "Système",
      description:
        "Surveillez le matériel et le stockage de ce serveur Spartan.",
      ...
      llamaBackend: {
        ...
        envLocked: "Fixé à {backend} par la variable d'environnement SPARTAN_LLAMA_CPP_BACKEND, qui prévaut sur ce réglage.",
        customPath: {
          ...
          bundled: "Utilise le runtime llama.cpp installé par Spartan.",
        ...
        unsupported: {
          ...
          localLink: "llama.cpp est un dossier local que vous avez lié vous-même ; Spartan ne le remplacera pas.",
    ...
    agents: {
      title: "Agents",
      description:
        "Connectez des agents de codage comme Claude Code et Codex à un modèle local avec Spartan start.",
      intro:
        "connecte Claude Code, Codex, Hermes, OpenClaw, OpenCode et d'autres agents à un modèle servi localement par Spartan, entièrement hors ligne. Il lance un serveur compatible OpenAI et ne touche jamais aux fichiers de configuration de votre agent.",
      ...
      modelNote:
        "Codex nécessite un modèle GGUF servi par llama-server. Les autres agents peuvent aussi utiliser des modèles basés sur transformers ; retirez --model pour utiliser le modèle déjà chargé dans Spartan.",
      subagent: {
        title: "Utiliser un modèle local comme sous-agent",
        description:
          "Gardez {agent} sur son modèle actuel et déléguez certaines tâches à ce modèle Spartan local.",
        ...
        opencodePrompt: "@Spartan trouve la cause de cet échec de test",
      },
      quickstart: {
      ...
      options: {
        ...
        description:
          "Les options Spartan sont analysées en premier ; tout ce qu'Spartan ne reconnaît pas est transmis tel quel à l'agent.",
        model:
          "Sélectionne un modèle. Sans --model, Spartan start utilise le modèle actuellement chargé dans Studio et échoue si aucun modèle n'est chargé.",
        contextLength:
        ...
        persist:
          "Conserve d'une exécution à l'autre les données d'agent gérées par Spartan.",
        asSubagent:
          "Garde l'agent parent sur son modèle actuel et enregistre Spartan comme sous-agent local (Claude Code, Codex et OpenCode).",
        apiKey:
          "Fournit votre clé API Spartan, ou lit la variable SPARTAN_API_KEY.",
        yolo:
      ...
      remote: {
        ...
        description:
          "Faites pointer Spartan start vers un Studio exécuté ailleurs en définissant ces variables avant le lancement (ou passez --api-key directement) :",
      },
      passthrough: {
        title: "Transmettre des arguments à l'agent",
        description:
          "Les arguments placés après les options Spartan sont transmis à l'agent lui-même, donc les commandes natives comme resume fonctionnent toujours :",
      },
      dryRun: {
    ...
    apiKeys: {
      title: "API",
      description: "Accédez à Spartan via l'API compatible OpenAI.",
      ...
      secureHttpsHint:
        "Le service lié à l’adresse 0.0.0.0 reste accessible sur toutes les interfaces réseau. Pour une sécurité complète, lancez Spartan avec --secure afin de n’exposer que ce lien HTTPS.",
    ...
    about: {
      ...
      shutDownStudio: "Arrêter Spartan",
      shutDownStudioDescription:
        "Arrête le serveur Spartan et met fin à votre session.",
      shutDown: "Arrêter",
      update: {
        title: "Mettre à jour Spartan",
        commandText: "Texte de la {label}",
        copied: "Copié",
        copyCommand: "Copier la commande",
        commandCopied: "{label} copiée",
        copyNamedCommand: "Copier la {label}",
        checkingInstall: "Vérification du mode d'installation d'Spartan...",
        installIntro: "Pour installer ou mettre à jour Spartan :",
        ...
        restartAfterUpdate: "Redémarrez Spartan après la mise à jour.",
        desktopManaged:
        ...
        desktopExternalServer:
          "Exécutez `Spartan Studio update` dans le terminal depuis lequel vous avez lancé le serveur.",
        ...
        desktopCurrentDescription:
          "Spartan continuera à rechercher automatiquement les mises à jour.",
        ...
        unknownInstall:
          "Impossible de détecter le mode d'installation d'Spartan. Pour les installations via installateur ou PyPI, utilisez les commandes ci-dessus.",
        localCheckout:
  ...
  studio: {
    ...
    training: {
      ...
      startUnconfirmed:
        "Spartan n'a pas pu confirmer le démarrage de l'entraînement. Vérification de l'état en arrière-plan.",
    ...
    trainingStart: {
      ...
      terminalStart: "> l'entraînement Spartan démarre...",
