...
export const hi = {
  ...
  settings: {
    ...
    dialog: {
      title: "सेटिंग्स",
      description: "अपनी Spartan प्राथमिकताएँ प्रबंधित करें।",
    ...
    debugging: {
      ...
      disabled: "फ़ाइल में लॉगिंग बंद है (SPARTAN_STUDIO_NO_FILE_LOG=1)।",
    ...
    voice: {
      ...
      dictation: {
        ...
        sttLoaded: "लोड है",
        sttUnavailable:
          "इस सर्वर पर इंस्टॉल नहीं है। लोकल डिक्टेशन चालू करने के लिए `Spartan Studio update` चलाएँ।",
        ...
        micAccessBlocked:
          "माइक्रोफ़ोन एक्सेस रोक दिया गया है। इस Spartan पेज के लिए माइक्रोफ़ोन एक्सेस की अनुमति दें, फिर दोबारा कोशिश करें।",
    ...
    general: {
      title: "सामान्य",
      description: "Spartan के लिए वैश्विक प्राथमिकताएं।",
      account: "खाता",
      ...
      password: "पासवर्ड",
      passwordDescription: "इस Spartan खाते के लिए पासवर्ड बदलें।",
      passwordDialog: {
        ...
        setDescription:
          "वह पासवर्ड चुनें जिससे रिमोट ब्राउज़र Spartan के रूप में साइन इन करते हैं (कम से कम {minLength} अक्षर)। Spartan डेस्कटॉप ऐप स्वतः साइन इन करता रहेगा।",
      ...
      helperLlm: {
        ...
        disabledByEnv:
          "बैकएंड एनवायरनमेंट में SPARTAN_HELPER_MODEL_DISABLE द्वारा अक्षम।",
      ...
      modelAutoSwitch: {
        ...
        idleActiveViaEnv:
          "निष्क्रिय ऑटो-अनलोड SPARTAN_MODEL_IDLE_TTL एनवायरनमेंट वेरिएबल के माध्यम से सक्रिय है।",
      ...
      startup: {
        ...
        launchAtLogin: "लॉगिन पर Spartan चलाएं",
        launchAtLoginDescription:
          "लॉगिन करने पर Spartan को बैकग्राउंड में शुरू करता है। इसे खोलने तक यह मेनू बार या सिस्टम ट्रे में रहता है।",

        closeToTray: "सिस्टम ट्रे में बंद करें",
        closeToTrayDescription:
          "मुख्य विंडो बंद करने पर Spartan और उसके सर्वर को बैकग्राउंड में चलते रहने दें।",
      ...
      resetPreferences: {
        ...
        confirmDescription:
          "केवल-स्थानीय प्राथमिकताएं साफ़ करता है और Spartan को फिर से लोड करता है। चैट, API एक्सेस, और DB-समर्थित सेटिंग्स बनी रहती हैं।",
      ...
      permissions: {
        ...
        bypassDescription:
          "चैट के टूल कॉल (टर्मिनल, python, वेब, MCP) चलाने से पहले Spartan उन्हें कैसे मंज़ूरी देता है। “Full access” मोड से मंज़ूरी और कोड सैंडबॉक्स बंद हो जाते हैं।",
      },
    },
    profile: {
      title: "प्रोफ़ाइल",
      description: "Spartan में आपकी प्रोफ़ाइल कैसे दिखती है।",
      changePicture: "प्रोफ़ाइल चित्र बदलें",
      displayName: "प्रदर्शन नाम",
      nickname: "Spartan आपको क्या कहकर बुलाए?",
      ...
      stats: {
        title: "आपके आँकड़े",
        subtitle:
          "नीचे सब कुछ आपके अपने इतिहास से गिना जाता है। कुछ भी इकट्ठा नहीं किया जाता और न ही Spartan को भेजा जाता है।",
        retry: "फिर कोशिश करें",
        privacyNote:
          "आँकड़े आपके Spartan इंस्टॉल में मौजूद चैट और ट्रेनिंग इतिहास से गिने जाते हैं। कुछ भी इकट्ठा नहीं किया जाता, और Spartan या किसी तीसरे पक्ष को कुछ नहीं भेजा जाता।",
        emptyChats:
    ...
    appearance: {
      title: "रूप-रंग",
      description: "इस डिवाइस पर Spartan कैसा दिखता है।",
      theme: {
        title: "थीम",
        label: "रंग योजना",
      ...
      palette: {
        label: "रंग पैलेट",
        description: "लाइट और डार्क मोड में पूरे Spartan में दिखने वाले रंग।",
        standard: "मानक",
        classic: "क्लासिक",
        minimal: "मिनिमल",
      },
      custom: {
        ...
        uiFontSize: {
          ...
          description: "Spartan UI के लिए उपयोग होने वाला आधार आकार समायोजित करें।",
        },
        codeFontSize: {
      ...
      language: {
        title: "भाषा",
        label: "प्रदर्शन भाषा",
        description: "Spartan द्वारा उपयोग की जाने वाली भाषा।",
    ...
    resources: {
      title: "सिस्टम",
      description: "इस Spartan सर्वर के हार्डवेयर और स्टोरेज की निगरानी करें।",
      ...
      llamaBackend: {
        ...
        envLocked: "पर्यावरण चर SPARTAN_LLAMA_CPP_BACKEND ने इसे {backend} पर तय किया है, जो इस सेटिंग पर भारी पड़ता है।",
        customPath: {
          ...
          bundled: "Spartan द्वारा इंस्टॉल किया गया llama.cpp रनटाइम इस्तेमाल करता है।",
        ...
        unsupported: {
          ...
          localLink: "llama.cpp आपकी अपनी लिंक की हुई लोकल डायरेक्टरी है, इसलिए Spartan उसे नहीं बदलेगा।",
    ...
    agents: {
      title: "एजेंट",
      description:
        "Spartan start की मदद से Claude Code और Codex जैसे कोडिंग एजेंट को लोकल मॉडल से जोड़ें।",
      intro:
        "Claude Code, Codex, Hermes, OpenClaw, OpenCode और दूसरे एजेंट को Spartan द्वारा लोकली सर्व किए गए मॉडल से जोड़ता है, पूरी तरह ऑफ़लाइन। यह एक OpenAI-संगत सर्वर चलाता है और आपके एजेंट की कॉन्फ़िगरेशन फ़ाइलों को कभी नहीं छूता।",
      ...
      modelNote:
        "Codex को llama-server द्वारा सर्व किया गया GGUF मॉडल चाहिए। दूसरे एजेंट Transformers-आधारित मॉडल भी उपयोग कर सकते हैं; Spartan में पहले से लोड किए गए मॉडल का उपयोग करने के लिए --model हटा दें।",
      subagent: {
        title: "लोकल मॉडल को सबएजेंट के रूप में उपयोग करें",
        description:
          "{agent} को उसके मौजूदा मॉडल पर ही रहने दें और चुने हुए काम इस लोकल Spartan मॉडल को सौंपें।",
        ...
        opencodePrompt: "@Spartan इस टेस्ट के फेल होने की वजह ढूंढो",
      },
      quickstart: {
        title: "कमांड बनाएं",
        description:
      ...
      options: {
        ...
        description:
          "Spartan के फ़्लैग पहले पढ़े जाते हैं; जो पहचान में नहीं आता वह सीधे एजेंट को भेज दिया जाता है।",
        model:
          "मॉडल चुनता है। --model न देने पर Spartan start वही मॉडल उपयोग करता है जो Studio में लोड है, और कोई लोड न हो तो त्रुटि देता है।",
        contextLength:
        ...
        persist:
          "Spartan द्वारा प्रबंधित एजेंट स्टोरेज को रनों के बीच बनाए रखता है।",
        asSubagent:
          "मूल एजेंट को उसके मौजूदा मॉडल पर रखता है और Spartan को लोकल सबएजेंट के रूप में दर्ज करता है (Claude Code, Codex और OpenCode)।",
        apiKey:
          "आपकी Spartan API key लेता है (या SPARTAN_API_KEY सेट करें)।",
        yolo:
      ...
      remote: {
        ...
        description:
          "चलाने से पहले ये सेट करके Spartan start को कहीं और चल रहे Studio की ओर भेजें (या --api-key सीधे दें):",
      },
      passthrough: {
        title: "एजेंट को आर्ग्युमेंट भेजना",
        description:
          "Spartan के फ़्लैग के बाद दिए गए आर्ग्युमेंट सीधे एजेंट को भेजे जाते हैं, इसलिए resume जैसे एजेंट के अपने कमांड काम करते रहते हैं:",
      },
      dryRun: {
    ...
    apiKeys: {
      title: "API",
      description: "OpenAI-संगत API के माध्यम से Spartan तक पहुंचें।",
      ...
      secureHttpsHint:
        "0.0.0.0 वाला पोर्ट अब भी विश्व स्तर पर पहुँचा जा सकता है। पूरी सुरक्षा के लिए Spartan को --secure के साथ शुरू करें, ताकि केवल यह HTTPS लिंक उपलब्ध हो।",
    ...
    about: {
      ...
      shutDownStudio: "Spartan शट डाउन करें",
      shutDownStudioDescription:
        "Spartan सर्वर को रोकता है और आपके सत्र को समाप्त करता है।",
      shutDown: "शट डाउन करें",
      update: {
        title: "Spartan अपडेट करें",
        commandText: "{label} का टेक्स्ट",
        copied: "कॉपी किया गया",
        copyCommand: "कमांड कॉपी करें",
        commandCopied: "{label} कॉपी किया गया",
        copyNamedCommand: "{label} कॉपी करें",
        checkingInstall: "जांच रहे हैं कि Spartan कैसे इंस्टॉल किया गया था...",
        installIntro: "Spartan इंस्टॉल या अपडेट करने के लिए:",
        ...
        restartAfterUpdate: "अपडेट करने के बाद Spartan को पुनः आरंभ करें।",
        desktopManaged:
        ...
        desktopExternalServer:
          "जिस टर्मिनल से सर्वर शुरू किया गया था, उसमें `Spartan Studio update` चलाएँ।",
        ...
        desktopCurrentDescription: "Spartan अपने-आप जाँच करता रहेगा।",
        ...
        unknownInstall:
          "यह पता नहीं लगाया जा सका कि Spartan कैसे इंस्टॉल किया गया था। इंस्टॉलर या PyPI इंस्टॉल के लिए, ऊपर दिए गए कमांड का उपयोग करें।",
        localCheckout:
  ...
  studio: {
    ...
    training: {
      ...
      startUnconfirmed:
        "Spartan यह पुष्टि नहीं कर सका कि ट्रेनिंग शुरू हुई या नहीं। बैकग्राउंड में स्थिति जांची जा रही है।",
    ...
    trainingStart: {
      ...
      terminalStart: "> Spartan ट्रेनिंग शुरू हो रही है...",
