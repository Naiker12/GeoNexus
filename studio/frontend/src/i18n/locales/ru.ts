...
export const ru = {
  ...
  settings: {
    ...
    dialog: {
      title: "Настройки",
      description: "Управление настройками Spartan.",
    ...
    debugging: {
      ...
      disabled: "Запись журнала в файл отключена (SPARTAN_STUDIO_NO_FILE_LOG=1).",
    ...
    voice: {
      ...
      dictation: {
        ...
        sttLoaded: "Загружено",
        sttUnavailable:
          "Компонент не установлен на этом сервере. Выполните `Spartan Studio update`, чтобы включить локальную диктовку.",
        sttRetry: "Повторить",
        ...
        micAccessBlocked:
          "Доступ к микрофону заблокирован. Разрешите доступ к микрофону для этой страницы Spartan и повторите попытку.",
    ...
    general: {
      title: "Общие",
      description: "Глобальные настройки Spartan.",
      account: "Аккаунт",
      ...
      password: "Пароль",
      passwordDescription: "Изменить пароль для этого аккаунта Spartan.",
      passwordDialog: {
        ...
        setDescription:
          "Выберите пароль, с которым удалённые браузеры входят как Spartan (не менее {minLength} символов). Настольное приложение Spartan продолжит входить автоматически.",
      ...
      helperLlm: {
        ...
        disabledByEnv:
          "Отключено переменной SPARTAN_HELPER_MODEL_DISABLE в окружении бэкенда.",
      ...
      modelAutoSwitch: {
        ...
        idleActiveViaEnv: "Активно через SPARTAN_MODEL_IDLE_TTL.",
      ...
      startup: {
        ...
        launchAtLogin: "Запускать Spartan при входе в систему",
        launchAtLoginDescription:
          "Запускает Spartan в фоновом режиме при входе в систему. Приложение остаётся в строке меню или системном трее, пока вы его не откроете.",

        closeToTray: "Закрывать в системный трей",
        closeToTrayDescription:
          "Оставлять Spartan и его сервер работающими в фоне при закрытии главного окна.",
      ...
      resetPreferences: {
        ...
        confirmDescription:
          "Очищает только локальные настройки и перезагружает Spartan. Чаты, доступ по API и настройки в базе данных сохраняются.",
      ...
      permissions: {
        ...
        bypassDescription:
          "Как Spartan подтверждает вызовы инструментов в чате (терминал, python, веб, MCP) перед запуском. Режим «Full access» отключает подтверждения и песочницу для кода.",
      },
    },
    profile: {
      title: "Профиль",
      description: "Как ваш профиль отображается в Spartan.",
      changePicture: "Изменить фото профиля",
      displayName: "Отображаемое имя",
      nickname: "Как Spartan к вам обращаться?",
      ...
      stats: {
        ...
        subtitle:
          "Всё ниже считается по вашей собственной истории. Ничего не собирается и не отправляется в Spartan.",
        retry: "Повторить",
        privacyNote:
          "Статистика рассчитывается по истории чатов и обучения, которая хранится в вашей установке Spartan. Ничего не собирается и ничего не отправляется ни в Spartan, ни третьим лицам.",
        emptyChats:
    ...
    appearance: {
      title: "Оформление",
      description: "Как Spartan выглядит на этом устройстве.",
      theme: {
        title: "Тема",
      ...
      palette: {
        ...
        description: "Цвета, используемые в Spartan в светлой и тёмной теме.",
      ...
      custom: {
        ...
        uiFontSize: {
          ...
          description: "Настройте базовый размер шрифта интерфейса Spartan.",
        },
        codeFontSize: {
      ...
      language: {
        ...
        description: "Язык, используемый Spartan.",
    ...
    resources: {
      title: "Система",
      description: "Мониторинг оборудования и хранилища этого сервера Spartan.",
      ...
      llamaBackend: {
        ...
        envLocked: "Значение {backend} задано переменной окружения SPARTAN_LLAMA_CPP_BACKEND, она важнее этой настройки.",
        customPath: {
          ...
          bundled: "Используется среда llama.cpp, установленная Spartan.",
        ...
        unsupported: {
          ...
          localLink: "llama.cpp, это локальный каталог, который вы подключили сами, и Spartan его не заменяет.",
    ...
    agents: {
      title: "Агенты",
      description:
        "Подключение кодинг-агентов, таких как Claude Code и Codex, к локальной модели с помощью Spartan start.",
      intro:
        "подключает Claude Code, Codex, Hermes, OpenClaw, OpenCode и других агентов к модели, которую Spartan обслуживает локально, полностью офлайн. Запускается OpenAI-совместимый сервер, а файлы конфигурации вашего агента остаются нетронутыми.",
      ...
      modelNote:
        "Codex требует модель GGUF, обслуживаемую llama-server. Другие агенты могут работать и с моделями на основе transformers; уберите --model, чтобы использовать модель, уже загруженную в Spartan.",
      subagent: {
        title: "Использовать локальную модель в качестве субагента",
        description:
          "Оставьте {agent} на текущей модели и делегируйте отдельные задачи этой локальной модели Spartan.",
        ...
        opencodePrompt: "@Spartan найди причину этого падения теста",
      },
      quickstart: {
      ...
      options: {
        ...
        description:
          "Сначала разбираются флаги Spartan; всё, что не распознано, передаётся агенту без изменений.",
        model:
          "Выбирает модель. Без --model команда Spartan start использует модель, уже загруженную в Studio, и завершается ошибкой, если модели нет.",
        contextLength:
        ...
        persist:
          "Сохраняет между запусками хранилище агента, управляемое Spartan.",
        asSubagent:
          "Оставляет родительского агента на текущей модели и регистрирует Spartan как локального субагента (Claude Code, Codex и OpenCode).",
        apiKey:
          "Передаёт ваш ключ API Spartan (альтернатива: переменная SPARTAN_API_KEY).",
        yolo:
      ...
      remote: {
        ...
        description:
          "Чтобы подключить Spartan start к удалённому экземпляру Studio, задайте перед запуском следующие переменные (или передайте --api-key напрямую):",
      },
      passthrough: {
        title: "Передача аргументов агенту",
        description:
          "Аргументы после флагов Spartan передаются самому агенту, поэтому его собственные команды вроде resume продолжают работать:",
      },
      dryRun: {
    ...
    apiKeys: {
      title: "API",
      description: "Доступ к Spartan через OpenAI-совместимый API.",
      ...
      secureHttpsHint:
        "Порт, привязанный к адресу 0.0.0.0, по-прежнему доступен глобально. Для полной безопасности запустите Spartan с флагом --secure, чтобы оставить доступ только по этой HTTPS-ссылке.",
    ...
    about: {
      ...
      shutDownStudio: "Выключить Spartan",
      shutDownStudioDescription:
        "Останавливает сервер Spartan и завершает вашу сессию.",
      shutDown: "Выключить",
      update: {
        title: "Обновить Spartan",
        commandText: "Текст «{label}»",
        copied: "Скопировано",
        copyCommand: "Копировать команду",
        commandCopied: "Скопировано: {label}",
        copyNamedCommand: "Копировать «{label}»",
        checkingInstall: "Проверка способа установки Spartan...",
        installIntro: "Чтобы установить или обновить Spartan:",
        ...
        localInstallDetected:
          "Обнаружена установка из локальной рабочей копии. Обновляйте Spartan из исходной рабочей копии, чтобы не заменить эту установку пакетом из PyPI.",
        pullThenUpdate:
        ...
        restartAfterUpdate: "После обновления перезапустите Spartan.",
        desktopManaged:
        ...
        desktopExternalServer:
          "Выполните `Spartan Studio update` в терминале, из которого был запущен сервер.",
        ...
        desktopCurrentDescription:
          "Spartan продолжит автоматически проверять наличие обновлений.",
        ...
        unknownInstall:
          "Не удалось определить способ установки Spartan. Для установки через установщик или PyPI используйте команды выше.",
        localCheckout:
  ...
  studio: {
    ...
    training: {
      ...
      startUnconfirmed:
        "Spartan не удалось подтвердить запуск обучения. Состояние проверяется в фоновом режиме.",
    ...
    trainingStart: {
      ...
      terminalStart: "> обучение Spartan начинается...",
