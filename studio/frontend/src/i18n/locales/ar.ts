...
export const ar = {
  ...
  shell: {
    ...
    aria: {
      home: "الصفحة الرئيسية لـ Spartan",
  ...
  settings: {
    ...
    dialog: {
      title: "الإعدادات",
      description: "إدارة تفضيلات Spartan الخاصة بك.",
    ...
    debugging: {
      ...
      disabled: "التسجيل في ملف مُعطَّل (SPARTAN_STUDIO_NO_FILE_LOG=1).",
    ...
    voice: {
      ...
      dictation: {
        ...
        sttLoaded: "مُحمَّل",
        sttUnavailable:
          "غير مثبّت على هذا الخادم. نفّذ `Spartan Studio update` لتفعيل الإملاء المحلي.",
        ...
        micAccessBlocked:
          "تم حظر الوصول إلى الميكروفون. اسمح بالوصول إلى الميكروفون لصفحة Spartan هذه ثم أعد المحاولة.",
    ...
    general: {
      title: "عام",
      description: "التفضيلات العامة لـ Spartan.",
      account: "الحساب",
      ...
      passwordDescription: "تغيير كلمة المرور لحساب Spartan هذا.",
      passwordDialog: {
        ...
        setDescription:
          "اختر كلمة المرور التي تسجّل بها المتصفحات البعيدة الدخول باسم Spartan (بحد أدنى {minLength} حرفًا). سيواصل تطبيق Spartan لسطح المكتب تسجيل الدخول تلقائيًا.",
      ...
      helperLlm: {
        ...
        disabledByEnv:
          "مُعطّل بواسطة SPARTAN_HELPER_MODEL_DISABLE في بيئة الخادم.",
      ...
      modelAutoSwitch: {
        ...
        idleActiveViaEnv:
          "التفريغ التلقائي عند الخمول مُفعَّل عبر متغير البيئة SPARTAN_MODEL_IDLE_TTL.",
      ...
      startup: {
        ...
        launchAtLogin: "تشغيل Spartan عند تسجيل الدخول",
        launchAtLoginDescription:
          "يبدأ Spartan في الخلفية عند تسجيل الدخول، ويبقى في شريط القوائم أو علبة النظام حتى تفتحه.",

        closeToTray: "الإغلاق إلى علبة النظام",
        closeToTrayDescription:
          "إبقاء Spartan وخادمه قيد التشغيل في الخلفية عند إغلاق النافذة الرئيسية.",
      ...
      resetPreferences: {
        ...
        confirmDescription:
          "يمسح التفضيلات المحلية فقط ويعيد تحميل Spartan. تُحفظ المحادثات ووصول API والإعدادات المخزّنة في قاعدة البيانات.",
      ...
      permissions: {
        ...
        bypassDescription:
          "كيفية موافقة Spartan على استدعاءات أدوات المحادثة (الطرفية، python، الويب، MCP) قبل تشغيلها. وضع «Full access» يعطّل الموافقات وصندوق عزل الشيفرة.",
      },
    },
    profile: {
      title: "الملف الشخصي",
      description: "كيفية ظهور ملفك الشخصي في Spartan.",
      changePicture: "تغيير صورة الملف الشخصي",
      displayName: "الاسم المعروض",
      nickname: "بماذا يجب أن يناديك Spartan؟",
      ...
      stats: {
        title: "إحصاءاتك",
        subtitle:
          "كل ما يلي محسوب من سجلك الخاص. لا يُجمَع أي شيء ولا يُرسَل إلى Spartan.",
        retry: "إعادة المحاولة",
        privacyNote:
          "تُحسب الإحصاءات من سجل المحادثات والتدريب المحفوظ في نسخة Spartan لديك. لا يُجمَع أي شيء، ولا يُرسَل شيء إلى Spartan أو إلى أي طرف ثالث.",
        emptyChats:
    ...
    appearance: {
      title: "المظهر",
      description: "كيفية ظهور Spartan على هذا الجهاز.",
      theme: {
        title: "السمة",
        label: "نظام الألوان",
      ...
      palette: {
        label: "لوحة الألوان",
        description: "الألوان المستخدمة في Spartan في الوضعين الفاتح والداكن.",
        standard: "قياسية",
        classic: "كلاسيكية",
        minimal: "بسيطة",
      },
      custom: {
        ...
        uiFontSize: {
          ...
          description: "اضبط الحجم الأساسي المستخدم في واجهة Spartan.",
        },
        codeFontSize: {
      ...
      language: {
        title: "اللغة",
        label: "لغة العرض",
        description: "اللغة التي يستخدمها Spartan.",
    ...
    resources: {
      title: "النظام",
      description: "راقب عتاد خادم Spartan هذا ومساحة تخزينه.",
      ...
      llamaBackend: {
        ...
        envLocked: "تم ضبطها على {backend} عبر متغيّر البيئة SPARTAN_LLAMA_CPP_BACKEND، وهو يتجاوز هذا الإعداد.",
        customPath: {
          ...
          bundled: "يستخدم وقت تشغيل llama.cpp الذي ثبّته Spartan.",
        ...
        unsupported: {
          ...
          localLink: "llama.cpp مجلد محلي ربطته بنفسك، ولن يستبدله Spartan.",
    ...
    agents: {
      title: "الوكلاء",
      description:
        "اربط وكلاء البرمجة مثل Claude Code وCodex بنموذج محلي باستخدام Spartan start.",
      intro:
        "يربط Claude Code وCodex وHermes وOpenClaw وOpenCode وغيرها من الوكلاء بنموذج يقدّمه Spartan محليًا، دون اتصال بالإنترنت تمامًا. يشغّل خادمًا متوافقًا مع OpenAI ولا يمسّ ملفات إعدادات وكيلك إطلاقًا.",
      ...
      modelNote:
        "يتطلب Codex نموذج GGUF يقدّمه llama-server. أما الوكلاء الآخرون فيمكنهم استخدام النماذج المبنية على transformers أيضًا؛ احذف ‎--model لاستخدام النموذج المُحمَّل بالفعل في Spartan.",
      subagent: {
        title: "استخدام نموذج محلي كوكيل فرعي",
        description:
          "أبقِ {agent} على نموذجه الحالي وفوّض مهام محددة إلى نموذج Spartan المحلي هذا.",
        ...
        opencodePrompt: "@Spartan ابحث عن سبب فشل هذا الاختبار",
      },
      quickstart: {
        title: "بناء أمر",
        description:
      ...
      options: {
        ...
        description:
          "تُحلَّل رايات Spartan أولًا؛ وأي شيء لا يتعرّف عليه يُمرَّر كما هو إلى الوكيل.",
        model:
          "يختار نموذجًا. بدون ‎--model يستخدم Spartan start النموذج المُحمَّل حاليًا في Studio، ويُظهر خطأ إن لم يكن هناك أي نموذج محمَّل.",
        contextLength:
        ...
        persist: "يحتفظ بمساحة تخزين الوكيل التي يديرها Spartan بين عمليات التشغيل.",
        asSubagent:
          "يبقي الوكيل الأصلي على نموذجه الحالي ويسجّل Spartan كوكيل فرعي محلي (Claude Code وCodex وOpenCode).",
        apiKey: "يمرّر مفتاح API الخاص بـ Spartan (أو اضبط SPARTAN_API_KEY).",
        yolo: "يتخطى طلبات الموافقة. استخدمه في البيئات الموثوقة فقط.",
      },
      remote: {
        title: "الاتصال بنسخة بعيدة من Studio",
        description:
          "وجّه Spartan start إلى نسخة من Studio تعمل في مكان آخر بضبط ما يلي قبل التشغيل (أو مرّر ‎--api-key مباشرة):",
      },
      passthrough: {
        title: "تمرير وسائط إلى الوكيل",
        description:
          "الوسائط التي تأتي بعد رايات Spartan تُمرَّر إلى الوكيل نفسه، لذا تظل أوامره الأصلية مثل resume تعمل:",
      },
      dryRun: {
    ...
    apiKeys: {
      title: "API",
      description: "الوصول إلى Spartan عبر واجهة API المتوافقة مع OpenAI.",
      ...
      secureHttpsHint:
        "لا يزال المنفذ على العنوان 0.0.0.0 متاحًا عالميًا. للحصول على أمان كامل، شغّل Spartan باستخدام --secure لإتاحة رابط HTTPS هذا فقط.",
    ...
    about: {
      ...
      shutDownStudio: "إيقاف تشغيل Spartan",
      shutDownStudioDescription:
        "يوقف خادم Spartan وينهي جلستك.",
      shutDown: "إيقاف التشغيل",
      update: {
        title: "تحديث Spartan",
        ...
        checkingInstall: "جارٍ التحقق من طريقة تثبيت Spartan...",
        installIntro: "لتثبيت أو تحديث Spartan:",
        ...
        restartAfterUpdate: "أعد تشغيل Spartan بعد التحديث.",
        desktopManaged:
        ...
        desktopExternalServer:
          "شغّل الأمر `Spartan Studio update` في الطرفية التي شغّلت الخادم.",
        ...
        desktopCurrentDescription: "سيواصل Spartan التحقق تلقائيًا.",
        ...
        unknownInstall:
          "تعذّر اكتشاف طريقة تثبيت Spartan. لعمليات تثبيت المثبّت أو PyPI، استخدم الأوامر أعلاه.",
        localCheckout:
  ...
  studio: {
    ...
    training: {
      ...
      startUnconfirmed:
        "تعذّر على Spartan تأكيد بدء التدريب. جارٍ التحقق من الحالة في الخلفية.",
    ...
    trainingStart: {
      ...
      terminalStart: "> يبدأ تدريب Spartan...",
