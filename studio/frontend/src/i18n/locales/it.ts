...
export const it = {
  ...
  settings: {
    ...
    dialog: {
      title: "Impostazioni",
      description: "Gestisci le tue preferenze di Spartan.",
    ...
    debugging: {
      ...
      disabled: "La registrazione su file è disattivata (SPARTAN_STUDIO_NO_FILE_LOG=1).",
    ...
    voice: {
      ...
      dictation: {
        ...
        sttLoaded: "Caricato",
        sttUnavailable:
          "Non installato su questo server. Esegui `Spartan Studio update` per abilitare la dettatura locale.",
        sttRetry: "Riprova",
        ...
        micAccessBlocked:
          "L'accesso al microfono è stato bloccato. Consenti l'accesso al microfono per questa pagina di Spartan, poi riprova.",
    ...
    general: {
      title: "Generali",
      description: "Preferenze globali di Spartan.",
      account: "Account",
      ...
      password: "Password",
      passwordDescription: "Cambia la password di questo account Spartan.",
      passwordDialog: {
        ...
        setDescription:
          "Scegli la password con cui i browser remoti accedono come Spartan (almeno {minLength} caratteri). L'app desktop di Spartan continua ad accedere automaticamente.",
      ...
      helperLlm: {
        ...
        disabledByEnv:
          "Disattivato da SPARTAN_HELPER_MODEL_DISABLE nell'ambiente del backend.",
        loadError:
      ...
      modelAutoSwitch: {
        ...
        idleActiveViaEnv: "Attivo tramite SPARTAN_MODEL_IDLE_TTL.",
        loadError:
      ...
      permissions: {
        ...
        bypassDescription:
          "Come Spartan approva le chiamate agli strumenti della chat (terminale, python, web, MCP) prima che vengano eseguite. La modalità «Full access» disattiva le approvazioni e la sandbox del codice.",
      },
      notifications: {
        sectionTitle: "Notifiche",
        showLlamaUpdates: "Notifiche di aggiornamento di llama.cpp",
        showLlamaUpdatesDescription:
          "Avvisa quando è disponibile una build più recente di llama.cpp per eseguire nuovi modelli. Disattiva le notifiche se usi Spartan solo per l'addestramento.",
      ...
      startup: {
        sectionTitle: "Avvio",
        launchAtLogin: "Avvia Spartan all'accesso",
        launchAtLoginDescription:
          "Avvia Spartan in background quando accedi. Rimane nella barra dei menu o nell'area di notifica finché non lo apri.",

        closeToTray: "Chiudi nell'area di notifica",
        closeToTrayDescription:
          "Mantieni Spartan e il suo server in esecuzione in background quando chiudi la finestra principale.",
      ...
      resetPreferences: {
        ...
        confirmDescription:
          "Cancella solo le preferenze locali e ricarica Spartan. Le chat, l'accesso API e le impostazioni salvate nel database restano invariati.",
        confirmAction: "Reimposta e ricarica",
      },
    },
    profile: {
      title: "Profilo",
      description: "Come appare il tuo profilo in Spartan.",
      ...
      nickname: "Come deve chiamarti Spartan?",
      ...
      stats: {
        ...
        subtitle:
          "Tutto quello che vedi qui è calcolato dalla tua cronologia. Nessun dato viene raccolto o inviato a Spartan.",
        retry: "Riprova",
        privacyNote:
          "Le statistiche sono calcolate dalla cronologia di chat e addestramenti presente nella tua installazione di Spartan. Nessun dato viene raccolto né inviato a Spartan o a terze parti.",
        emptyChats:
    ...
    appearance: {
      title: "Aspetto",
      description: "Come si presenta Spartan su questo dispositivo.",
      theme: {
        title: "Tema",
      ...
      palette: {
        ...
        description: "Colori usati in Spartan, nei temi chiaro e scuro.",
        standard: "Standard",
        classic: "Classica",
        minimal: "Minimale",
      },
      custom: {
        ...
        uiFontSize: {
          ...
          description:
            "Regola la dimensione di base usata nell'interfaccia di Spartan.",
        },
        codeFontSize: {
      ...
      language: {
        ...
        description: "La lingua usata da Spartan.",
    ...
    resources: {
      title: "Sistema",
      description:
        "Monitora hardware e archiviazione di questo server Spartan.",
      ...
      llamaBackend: {
        ...
        envLocked: "Impostato su {backend} dalla variabile d'ambiente SPARTAN_LLAMA_CPP_BACKEND, che ha la precedenza su questa opzione.",
        customPath: {
          ...
          bundled: "Usa il runtime llama.cpp installato da Spartan.",
        ...
        unsupported: {
          notInstalled: "Nessuna installazione di llama.cpp gestita da Spartan, quindi non c'è un backend da cambiare.",
          localLink: "llama.cpp è una cartella locale collegata da te, quindi Spartan non la sostituirà.",
    ...
    agents: {
      title: "Agenti",
      description:
        "Collega agenti di programmazione come Claude Code e Codex a un modello locale con Spartan start.",
      intro:
        "collega Claude Code, Codex, Hermes, OpenClaw, OpenCode e altri agenti a un modello servito localmente da Spartan, completamente offline. Avvia un server compatibile con le API OpenAI e non modifica i file di configurazione del tuo agente.",
      ...
      modelNote:
        "Codex richiede un modello GGUF servito da llama-server. Gli altri agenti possono usare anche modelli basati su transformer; rimuovi --model per usare il modello già caricato in Spartan.",
      subagent: {
        title: "Usa un modello locale come subagente",
        description:
          "Mantieni {agent} sul suo modello attuale e delega alcune attività a questo modello Spartan locale.",
        ...
        opencodePrompt: "@Spartan trova la causa di questo test che non passa",
      },
      quickstart: {
      ...
      options: {
        ...
        description:
          "I flag di Spartan vengono interpretati per primi; tutto ciò che Spartan non riconosce viene passato direttamente all'agente.",
        model:
          "Seleziona un modello. Senza --model, Spartan start usa il modello attualmente caricato in Studio e restituisce un errore se non ce n'è nessuno.",
        contextLength:
        ...
        persist:
          "Mantieni tra un'esecuzione e l'altra i dati dell'agente gestiti da Spartan.",
        asSubagent:
          "Mantieni l'agente principale sul suo modello attuale e registra Spartan come subagente locale (Claude Code, Codex e OpenCode).",
        apiKey:
          "Fornisci la tua chiave API Spartan (oppure imposta SPARTAN_API_KEY).",
        yolo: "Salta le richieste di approvazione. Usa solo in ambienti fidati.",
      },
      remote: {
        title: "Connettersi a uno Studio remoto",
        description:
          "Punta Spartan start a uno Studio in esecuzione altrove impostando queste variabili prima dell'avvio (oppure passa direttamente --api-key):",
      },
      passthrough: {
        title: "Passare argomenti all'agente",
        description:
          "Gli argomenti che seguono i flag di Spartan vengono inoltrati all'agente, così i comandi nativi come resume continuano a funzionare:",
      },
      dryRun: {
    ...
    apiKeys: {
      title: "API",
      description: "Accedi a Spartan tramite le API compatibili con OpenAI.",
      ...
      secureHttpsHint:
        "La porta su 0.0.0.0 resta raggiungibile da ovunque. Per la massima sicurezza avvia Spartan con --secure, così viene esposto solo questo link HTTPS.",
    ...
    about: {
      ...
      studioVersion: "Versione di Spartan",
      ...
      shutDownStudio: "Arresta Spartan",
      shutDownStudioDescription:
        "Ferma il server Spartan e termina la tua sessione.",
      shutDown: "Arresta",
      update: {
        title: "Aggiorna Spartan",
        ...
        checkingInstall:
          "Verifica della modalità di installazione di Spartan...",
        installIntro: "Per installare o aggiornare Spartan:",
        ...
        restartAfterUpdate: "Riavvia Spartan dopo l'aggiornamento.",
        desktopManaged:
        ...
        desktopExternalServer:
          "Esegui `Spartan Studio update` nel terminale da cui hai avviato il server.",
        ...
        desktopCurrentDescription:
          "Spartan continuerà a verificare automaticamente la disponibilità di aggiornamenti.",
        ...
        unknownInstall:
          "Impossibile rilevare come è stato installato Spartan. Per installazioni tramite installer o PyPI, usa i comandi sopra.",
        localCheckout:
  ...
  studio: {
    ...
    training: {
      ...
      startUnconfirmed:
        "Spartan non ha potuto confermare l'avvio dell'addestramento. La verifica dello stato continua in background.",
    ...
    trainingStart: {
      ...
      terminalStart: "> avvio dell'addestramento con Spartan...",
