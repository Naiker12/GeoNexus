...
export const ko = {
  ...
  settings: {
    ...
    dialog: {
      title: "설정",
      description: "Spartan 환경설정을 관리합니다.",
    ...
    debugging: {
      ...
      disabled: "파일 로깅이 꺼져 있습니다 (SPARTAN_STUDIO_NO_FILE_LOG=1).",
    ...
    voice: {
      ...
      dictation: {
        ...
        sttLoaded: "로드됨",
        sttUnavailable:
          "이 서버에 설치되어 있지 않습니다. 로컬 받아쓰기를 사용하려면 `Spartan Studio update`를 실행하세요.",
        sttRetry: "다시 시도",
        ...
        micAccessBlocked:
          "마이크 접근이 차단되었습니다. 이 Spartan 페이지에 마이크 접근을 허용한 뒤 다시 시도하세요.",
    ...
    general: {
      ...
      password: "비밀번호",
      passwordDescription: "이 Spartan 계정의 비밀번호를 변경합니다.",
      passwordDialog: {
        trigger: "비밀번호 변경",
        title: "비밀번호 변경",
        description:
        ...
        setTitle: "원격 비밀번호 설정",
        setDescription:
          "원격 브라우저가 Spartan 계정으로 로그인할 때 사용할 비밀번호를 선택하세요(최소 {minLength}자). Spartan 데스크톱 앱은 계속 자동으로 로그인합니다.",
        setSubmit: "비밀번호 설정",
        setting: "설정 중...",
      ...
      helperLlm: {
        ...
        disabledByEnv:
          "백엔드 환경의 SPARTAN_HELPER_MODEL_DISABLE에 의해 비활성화되었습니다.",
      ...
      modelAutoSwitch: {
        ...
        idleActiveViaEnv:
          "유휴 시 자동 해제가 SPARTAN_MODEL_IDLE_TTL 환경 변수를 통해 활성화되어 있습니다.",
      ...
      startup: {
        sectionTitle: "시작",
        launchAtLogin: "로그인 시 Spartan 실행",
        launchAtLoginDescription:
          "로그인하면 Spartan를 백그라운드에서 시작합니다. 열기 전까지 메뉴 막대 또는 시스템 트레이에 남아 있습니다.",

        closeToTray: "시스템 트레이로 닫기",
        closeToTrayDescription:
          "기본 창을 닫아도 Spartan와 서버가 백그라운드에서 계속 실행되도록 합니다.",
      ...
      resetPreferences: {
        ...
        confirmDescription:
          "로컬 전용 환경설정을 지우고 Spartan를 다시 로드합니다. 채팅, API 접근 권한, DB 기반 설정은 유지됩니다.",
      ...
      permissions: {
        ...
        bypassLabel: "도구 권한",
        bypassDescription:
          "채팅의 도구 호출(터미널, python, 웹, MCP)을 실행하기 전에 Spartan가 승인하는 방식입니다. “Full access”를 선택하면 승인과 코드 샌드박스가 꺼집니다.",
      },
    },
    profile: {
      title: "프로필",
      ...
      stats: {
        title: "내 통계",
        subtitle:
          "아래 내용은 모두 본인의 기록을 바탕으로 계산됩니다. 아무것도 수집하거나 Spartan로 전송하지 않습니다.",
        retry: "다시 시도",
        privacyNote:
          "통계는 사용 중인 Spartan에 저장된 채팅 및 학습 기록을 바탕으로 계산됩니다. 아무것도 수집하지 않으며, Spartan나 제3자에게 전송하지 않습니다.",
        emptyChats:
    ...
    appearance: {
      title: "외관",
      description: "이 기기에서 Spartan가 표시되는 방식입니다.",
      theme: {
        title: "테마",
        label: "색상 구성",
      ...
      palette: {
        label: "색상 팔레트",
        description: "라이트 모드와 다크 모드에서 Spartan 전반에 쓰이는 색상입니다.",
        standard: "표준",
        classic: "클래식",
        minimal: "미니멀",
      },
      custom: {
        ...
        uiFontSize: {
          label: "UI 글꼴 크기",
          description: "Spartan UI에 쓰이는 기본 크기를 조정합니다.",
        },
        codeFontSize: {
          label: "코드 글꼴 크기",
    ...
    resources: {
      title: "시스템",
      description: "이 Spartan 서버의 하드웨어와 저장소를 모니터링합니다.",
      ...
      llamaBackend: {
        ...
        envLocked: "환경 변수 SPARTAN_LLAMA_CPP_BACKEND가 {backend}(으)로 고정했으며, 이 설정보다 우선합니다.",
        customPath: {
        ...
        unsupported: {
          ...
          localLink: "llama.cpp는 직접 연결한 로컬 디렉터리이므로 Spartan가 교체하지 않습니다.",
    ...
    agents: {
      title: "에이전트",
      description:
        "Spartan start로 Claude Code, Codex 같은 코딩 에이전트를 로컬 모델에 연결하세요.",
      intro:
        "명령은 Claude Code, Codex, Hermes, OpenClaw, OpenCode를 비롯한 에이전트를 Spartan가 로컬에서 제공하는 모델에 완전히 오프라인으로 연결합니다. OpenAI 호환 서버를 실행하며 에이전트의 설정 파일은 전혀 건드리지 않습니다.",
      readDocs: "문서 보기",
      copy: "복사",
      copied: "복사됨",
      ...
      modelNote:
        "Codex에는 llama-server가 제공하는 GGUF 모델이 필요합니다. 다른 에이전트는 transformers 기반 모델도 사용할 수 있습니다. Spartan에 이미 로드된 모델을 쓰려면 --model을 빼세요.",
      subagent: {
        title: "로컬 모델을 서브에이전트로 사용",
        description:
          "{agent}는 현재 모델을 유지한 채, 선택한 작업만 이 로컬 Spartan 모델에 위임합니다.",
        setupCommand: "설정 명령",
        ...
        opencodePrompt: "@Spartan 이 테스트 실패의 원인을 찾아줘",
      },
      quickstart: {
        title: "명령 만들기",
        description:
      ...
      options: {
        title: "주요 옵션",
        description:
          "Spartan 플래그가 먼저 처리되고, 인식되지 않은 값은 그대로 에이전트에 전달됩니다.",
        model:
          "모델을 선택합니다. --model이 없으면 Spartan start는 Studio에 현재 로드된 모델을 사용하며, 로드된 모델이 없으면 오류가 납니다.",
        contextLength:
        ...
        apiKey:
          "Spartan API 키를 지정합니다(또는 SPARTAN_API_KEY 환경 변수를 설정합니다).",
        yolo: "승인 확인을 건너뜁니다. 신뢰할 수 있는 환경에서만 사용하세요.",
      },
      remote: {
        title: "원격 Studio에 연결",
        description:
          "실행 전에 다음을 설정하면 Spartan start를 다른 곳에서 실행 중인 Studio로 연결할 수 있습니다(또는 --api-key를 직접 전달):",
      },
      passthrough: {
        title: "에이전트에 인자 전달",
        description:
          "Spartan 플래그 뒤의 인자는 에이전트 자체로 전달되므로 resume 같은 기본 명령도 그대로 동작합니다:",
      },
      dryRun: {
        title: "실행하지 않고 미리 보기",
        description:
    ...
    apiKeys: {
      title: "API",
      description: "OpenAI 호환 API를 통해 Spartan에 접근합니다.",
      readDocs: "API 문서 읽기",
      ...
      secureHttpsHint:
        "0.0.0.0 포트는 여전히 전역에서 접근할 수 있습니다. 완전한 보안을 위해서는 --secure로 Spartan를 실행하여 이 HTTPS 링크만 노출하세요.",
    ...
    about: {
      ...
      dangerZone: "위험 구역",
      shutDownStudio: "Spartan 종료",
      shutDownStudioDescription:
        "Spartan 서버를 중지하고 세션을 종료합니다.",
      shutDown: "종료",
      update: {
        title: "Spartan 업데이트",
        ...
        restartAfterUpdate: "업데이트 후 Spartan를 다시 시작하세요.",
        desktopManaged:
        ...
        desktopExternalServer:
          "서버를 시작한 터미널에서 `Spartan Studio update`를 실행하세요.",
        ...
        unknownInstall:
          "Spartan 설치 방식을 감지할 수 없습니다. 설치 프로그램 또는 PyPI 설치의 경우 위 명령을 사용하세요.",
        localCheckout:
  ...
  studio: {
    ...
    trainingStart: {
      ...
      terminalStart: "> Spartan 학습을 시작합니다...",
