...
export const de = {
  picker: {
    selectModel: "Modell auswählen", invalidModel: "Das ausgewählte Modell ist ungültig.", modelLoadFailed: "Modell konnte nicht geladen werden", modelLoadFailedDescription: "Das Modell konnte nicht geladen werden.",
  ...
  settings: {
    ...
    dialog: {
      title: "Einstellungen",
      description: "Verwalten Sie Ihre Spartan-Einstellungen.",
    ...
    debugging: {
      ...
      disabled: "Die Protokollierung in eine Datei ist deaktiviert (SPARTAN_STUDIO_NO_FILE_LOG=1).",
    ...
    voice: {
      ...
      dictation: {
        ...
        sttLoaded: "Geladen",
        sttUnavailable:
          "Auf diesem Server nicht installiert. Führen Sie `Spartan Studio update` aus, um das lokale Diktat zu aktivieren.",
        ...
        micAccessBlocked:
          "Der Mikrofonzugriff wurde blockiert. Erlauben Sie den Mikrofonzugriff für diese Spartan-Seite und versuchen Sie es erneut.",
    ...
    general: {
      title: "Allgemein",
      description: "Globale Einstellungen für Spartan.",
      account: "Konto",
      ...
      password: "Passwort",
      passwordDescription:
        "Ändern Sie das Passwort für dieses Spartan-Konto.",
      passwordDialog: {
        ...
        setDescription:
          "Wählen Sie das Passwort, mit dem sich entfernte Browser als Spartan anmelden (mindestens {minLength} Zeichen). Die Spartan Desktop-App meldet sich weiterhin automatisch an.",
      ...
      helperLlm: {
        ...
        disabledByEnv:
          "Deaktiviert durch SPARTAN_HELPER_MODEL_DISABLE in der Backend-Umgebung.",
      ...
      modelAutoSwitch: {
        ...
        idleActiveViaEnv:
          "Automatisches Entladen bei Inaktivität ist über die Umgebungsvariable SPARTAN_MODEL_IDLE_TTL aktiv.",
        loadError:
      ...
      startup: {
        ...
        launchAtLogin: "Spartan bei der Anmeldung starten",
        launchAtLoginDescription:
          "Startet Spartan im Hintergrund, wenn Sie sich anmelden. Es bleibt in der Menüleiste bzw. im Infobereich, bis Sie es öffnen.",

        closeToTray: "In den Infobereich schließen",
        closeToTrayDescription:
          "Spartan und seinen Server im Hintergrund weiterlaufen lassen, wenn Sie das Hauptfenster schließen.",
      ...
      resetPreferences: {
        ...
        confirmDescription:
          "Löscht nur lokal gespeicherte Einstellungen und lädt Spartan neu. Chats, API-Zugriff und in der DB gespeicherte Einstellungen bleiben erhalten.",
      ...
      permissions: {
        ...
        bypassDescription:
          "Wie Spartan Tool-Aufrufe im Chat (Terminal, Python, Web, MCP) vor der Ausführung freigibt. „Full access“ deaktiviert die Freigaben und die Code-Sandbox.",
      },
    },
    profile: {
      title: "Profil",
      description: "Wie Ihr Profil in Spartan angezeigt wird.",
      changePicture: "Profilbild ändern",
      displayName: "Anzeigename",
      nickname: "Wie soll Spartan Sie nennen?",
      ...
      stats: {
        ...
        subtitle:
          "Alles Folgende wird aus Ihrem eigenen Verlauf berechnet. Es wird nichts erfasst oder an Spartan gesendet.",
        retry: "Erneut versuchen",
        privacyNote:
          "Die Statistiken werden aus dem Chat- und Trainingsverlauf berechnet, der in Ihrer Spartan-Installation gespeichert ist. Es wird nichts erfasst und nichts an Spartan oder Dritte gesendet.",
        emptyChats:
    ...
    appearance: {
      title: "Darstellung",
      description: "Wie Spartan auf diesem Gerät aussieht.",
      theme: {
        title: "Design",
        label: "Farbschema",
      ...
      palette: {
        label: "Farbpalette",
        description: "Farben, die in Spartan im hellen und dunklen Modus verwendet werden.",
        standard: "Standard",
        classic: "Klassisch",
        minimal: "Minimal",
      },
      custom: {
        ...
        uiFontSize: {
          ...
          description: "Passen Sie die Grundgröße der Spartan-Oberfläche an.",
        },
        codeFontSize: {
      ...
      language: {
        ...
        description: "Die von Spartan verwendete Sprache.",
    ...
    resources: {
      title: "System",
      description:
        "Überwachen Sie Hardware und Speicher dieses Spartan-Servers.",
      ...
      llamaBackend: {
        ...
        envLocked: "Durch die Umgebungsvariable SPARTAN_LLAMA_CPP_BACKEND auf {backend} festgelegt; sie überschreibt diese Einstellung.",
        customPath: {
          ...
          bundled: "Verwendet die von Spartan installierte llama.cpp-Laufzeit.",
        ...
        unsupported: {
          notInstalled: "Es wurde keine von Spartan verwaltete llama.cpp-Installation gefunden, daher gibt es kein Backend zum Wechseln.",
          localLink: "llama.cpp ist ein selbst verknüpftes lokales Verzeichnis, das Spartan nicht ersetzt.",
    ...
    agents: {
      title: "Agenten",
      description:
        "Verbinden Sie Coding-Agenten wie Claude Code und Codex über Spartan start mit einem lokalen Modell.",
      intro:
        "verbindet Claude Code, Codex, Hermes, OpenClaw, OpenCode und weitere Agenten mit einem lokal von Spartan bereitgestellten Modell, vollständig offline. Es startet einen OpenAI-kompatiblen Server und verändert nie die Konfigurationsdateien Ihres Agenten.",
      ...
      modelNote:
        "Codex benötigt ein GGUF-Modell, das von llama-server bereitgestellt wird. Andere Agenten können auch Transformer-basierte Modelle verwenden; lassen Sie --model weg, um das bereits in Spartan geladene Modell zu nutzen.",
      subagent: {
        title: "Ein lokales Modell als Subagent verwenden",
        description:
          "Belassen Sie {agent} bei seinem aktuellen Modell und delegieren Sie ausgewählte Aufgaben an dieses lokale Spartan-Modell.",
        ...
        opencodePrompt: "@Spartan finde die Ursache dieses Testfehlers",
      },
      quickstart: {
      ...
      options: {
        ...
        persist:
          "Behält die von Spartan verwalteten Agent-Daten über Läufe hinweg bei.",
        asSubagent:
          "Belässt den übergeordneten Agenten bei seinem aktuellen Modell und registriert Spartan als lokalen Subagenten (Claude Code, Codex und OpenCode).",
        apiKey:
          "Übergibt Ihren Spartan-API-Schlüssel (alternativ SPARTAN_API_KEY setzen).",
        yolo:
      ...
      remote: {
        ...
        description:
          "Richten Sie Spartan start auf ein anderswo laufendes Studio aus, indem Sie diese Variablen vor dem Aufruf setzen (oder --api-key direkt übergeben):",
      },
      passthrough: {
        title: "Argumente an den Agenten übergeben",
        description:
          "Argumente nach den Spartan-Optionen werden an den Agenten selbst weitergereicht, sodass native Befehle wie resume weiterhin funktionieren:",
      },
      dryRun: {
    ...
    apiKeys: {
      title: "API",
      description: "Zugriff auf Spartan über die OpenAI-kompatible API.",
      ...
      secureHttpsHint:
        "Der 0.0.0.0-Port ist weiterhin global erreichbar. Für vollständige Sicherheit starten Sie Spartan mit --secure, um nur diesen HTTPS-Link freizugeben.",
    ...
    about: {
      ...
      shutDownStudio: "Spartan herunterfahren",
      shutDownStudioDescription:
        "Stoppt den Spartan-Server und beendet Ihre Sitzung.",
      shutDown: "Herunterfahren",
      update: {
        title: "Spartan aktualisieren",
        commandText: "{label} als Text",
        copied: "Kopiert",
        copyCommand: "Befehl kopieren",
        commandCopied: "{label} kopiert",
        copyNamedCommand: "{label} kopieren",
        checkingInstall: "Es wird geprüft, wie Spartan installiert wurde...",
        installIntro: "So installieren oder aktualisieren Sie Spartan:",
        ...
        restartAfterUpdate: "Starten Sie Spartan nach dem Update neu.",
        desktopManaged:
        ...
        desktopExternalServer:
          "Führen Sie `Spartan Studio update` in dem Terminal aus, über das Sie Ihren Server gestartet haben.",
        ...
        desktopCurrentDescription:
          "Spartan sucht weiterhin automatisch nach Updates.",
        ...
        unknownInstall:
          "Es konnte nicht erkannt werden, wie Spartan installiert wurde. Verwenden Sie für Installer- oder PyPI-Installationen die obigen Befehle.",
        localCheckout:
  ...
  studio: {
    ...
    training: {
      ...
      startUnconfirmed:
        "Spartan konnte nicht bestätigen, ob das Training gestartet wurde. Der Status wird im Hintergrund geprüft.",
    ...
    trainingStart: {
      ...
      terminalStart: "> Spartan-Training beginnt...",
