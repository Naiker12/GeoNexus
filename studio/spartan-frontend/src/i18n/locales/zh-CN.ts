...
export const zhCN = {
  ...
  settings: {
    ...
    debugging: {
      ...
      copyVisible: "复制可见日志",
      empty: "目前还没有任何日志。",
      disabled: "文件日志已关闭 (SPARTAN_STUDIO_NO_FILE_LOG=1)。",
      missing: "未找到日志文件。",
      unreadable: "无法读取日志文件。",
    ...
    voice: {
      ...
      dictation: {
        ...
        sttLoaded: "已加载",
        sttUnavailable:
          "此服务器上未安装。请运行 `Spartan Studio update` 以启用本地语音输入。",
        sttRetry: "重试",
        ...
        micAccessBlocked:
          "麦克风访问已被阻止。请在浏览器中允许此 Spartan 页面使用麦克风，然后重试。",
    ...
    general: {
      ...
      password: "密码",
      passwordDescription: "更改此 Spartan 账号的密码。",
      passwordDialog: {
        trigger: "更改密码",
        title: "更改密码",
        ...
        setTitle: "设置远程密码",
        setDescription:
          "选择远程浏览器以 Spartan 身份登录时使用的密码（至少 {minLength} 个字符）。Spartan 桌面应用仍会自动登录。",
        setSubmit: "设置密码",
        setting: "正在设置...",
        setDone: "密码已设置。",
      ...
      helperLlm: {
        ...
        disabledByEnv:
          "已由后端环境中的 SPARTAN_HELPER_MODEL_DISABLE 禁用。",
      ...
      modelAutoSwitch: {
        ...
        idleActiveViaEnv: "已通过 SPARTAN_MODEL_IDLE_TTL 启用。",
      ...
      startup: {
        sectionTitle: "启动",
        launchAtLogin: "登录时运行 Spartan",
        launchAtLoginDescription:
          "登录系统时在后台启动 Spartan。在你打开它之前，它会一直驻留在菜单栏或系统托盘中。",

        closeToTray: "关闭到系统托盘",
        closeToTrayDescription:
          "关闭主窗口时，让 Spartan 及其服务器继续在后台运行。",
      ...
      resetPreferences: {
        ...
        confirmDescription:
          "这会清除仅保存在本地的偏好设置，然后重新加载 Spartan。聊天、API 访问权限和数据库中的设置不会受到影响。",
      ...
      permissions: {
        ...
        bypassLabel: "工具权限",
        bypassDescription:
          "设置 Spartan 执行聊天中的工具调用（终端、python、网页、MCP）前的审批方式。“Full access”会关闭审批和代码沙箱。",
      },
    },
    profile: {
      title: "个人资料",
      description: "你的个人资料在 Spartan 中的显示方式。",
      changePicture: "更换头像",
      displayName: "显示名称",
      nickname: "Spartan 应该怎么称呼你？",
      ...
      stats: {
        title: "你的统计",
        subtitle:
          "下面的内容全部根据你自己的历史记录统计。不会收集任何数据，也不会发送给 Spartan。",
        retry: "重试",
        privacyNote:
          "统计数据由你本地 Spartan 保存的聊天和训练历史计算得出。不收集任何数据，也不会发送给 Spartan 或任何第三方。",
    ...
    appearance: {
      title: "外观",
      description: "调整 Spartan 在此设备上的显示方式。",
      language: {
        title: "语言",
        label: "显示语言",
        description: "选择 Spartan 使用的语言。",
        autoDetect: "自动检测",
      },
      theme: {
        title: "主题",
      ...
      palette: {
        label: "调色板",
        description: "Spartan 全局使用的配色，支持浅色和深色模式。",
        standard: "标准",
        classic: "经典",
        minimal: "极简",
      },
      custom: {
        ...
        uiFontSize: {
          label: "界面字号",
          description: "调整 Spartan 界面的基准字号。",
        },
        codeFontSize: {
          label: "代码字号",
    ...
    resources: {
      title: "系统",
      description: "监控此 Spartan 服务器的硬件和存储。",
      liveUpdates: "实时更新",
      floatingWindow: "悬浮窗口",
      ...
      llamaBackend: {
        ...
        envLocked: "已由环境变量 SPARTAN_LLAMA_CPP_BACKEND 固定为 {backend}，其优先级高于此设置。",
        customPath: {
          ...
          automatic: "自动（内置）",
          bundled: "使用 Spartan 安装的 llama.cpp 运行时。",
        ...
        unsupported: {
          ...
          localLink: "llama.cpp 是你自己链接的本地目录，Spartan 不会替换它。",
    ...
    agents: {
      title: "智能体",
      description:
        "使用 Spartan start 将 Claude Code、Codex 等编程智能体连接到本地模型。",
      intro:
        "可将 Claude Code、Codex、Hermes、OpenClaw、OpenCode 等智能体连接到由 Spartan 在本地提供服务的模型，全程离线。它会启动一个兼容 OpenAI 的服务器，并且从不改动智能体的配置文件。",
      readDocs: "查看文档",
      copy: "复制",
      copied: "已复制",
      ...
      modelNote:
        "Codex 需要通过 llama-server 提供服务的 GGUF 模型。其他智能体也可以使用基于 transformers 的模型；去掉 --model 即可使用 Spartan 中已加载的模型。",
      subagent: {
        title: "将本地模型用作子智能体",
        description:
          "让 {agent} 保持当前模型，并把选定的任务委派给这个本地 Spartan 模型。",
        setupCommand: "配置命令",
        copySetupCommand: "复制子智能体配置命令",
        usagePrompt: "然后在 {agent} 中输入：",
        copyUsagePrompt: "复制子智能体调用提示词",
        defaultPrompt: "启动一个本地智能体来实现这个函数。",
        opencodePrompt: "@Spartan 找出这个测试失败的原因",
      },
      quickstart: {
        title: "生成命令",
        description:
      ...
      options: {
        title: "常用选项",
        description:
          "Spartan 的参数会先被解析；无法识别的参数会原样传给智能体。",
        model:
          "选择模型。不带 --model 时，Spartan start 会使用 Studio 中当前加载的模型；若没有已加载的模型则报错。",
        ...
        persist: "在多次运行之间保留由 Spartan 管理的智能体存储。",
        asSubagent:
          "让父智能体保持当前模型，并将 Spartan 注册为本地子智能体（Claude Code、Codex 和 OpenCode）。",
        apiKey: "提供你的 Spartan API 密钥（或设置 SPARTAN_API_KEY）。",
        yolo: "跳过确认提示。请仅在可信环境中使用。",
      },
      remote: {
        title: "连接到远程 Studio",
        description:
          "在启动前设置以下内容，即可让 Spartan start 指向运行在别处的 Studio（也可以直接传入 --api-key）：",
      },
      passthrough: {
        title: "向智能体传递参数",
        description:
          "Spartan 参数之后的参数会转发给智能体本身，因此 resume 之类的原生命令仍然可用：",
      },
      dryRun: {
        title: "仅预览，不启动",
        description:
    ...
    apiKeys: {
      title: "API",
      description: "通过兼容 OpenAI 的 API 以编程方式访问 Spartan。",
      readDocs: "阅读 API 文档",
      ...
      secureHttpsHint:
        "0.0.0.0 端口仍可被全网访问。如需完全安全，请使用 --secure 启动 Spartan，仅暴露此 HTTPS 链接。",
    ...
    about: {
      title: "关于",
      description: "文档、发布说明、反馈和 Spartan 构建信息。",
      studioVersion: "Spartan 版本",
      packageVersion: "包版本",
      ...
      dangerZone: "危险区域",
      shutDownStudio: "关闭 Spartan",
      shutDownStudioDescription: "停止 Spartan 服务进程并结束你的会话。",
      shutDown: "关闭",
      update: {
        title: "更新 Spartan",
        ...
        checkingInstall: "正在检查 Spartan 的安装方式...",
        installIntro: "安装或更新 Spartan：",
        ...
        restartAfterUpdate: "更新后请重启 Spartan。",
        desktopManaged:
        ...
        desktopExternalServer:
          "请在启动服务器的终端中运行 `Spartan Studio update`。",
        ...
        desktopCurrentDescription: "Spartan 会继续自动检查更新。",
        ...
        unknownInstall:
          "Spartan 无法检测安装方式。如果你使用一键安装器或 PyPI 安装，请使用上面的命令。",
        localCheckout:
  ...
  studio: {
    ...
    training: {
      ...
      startFailed: "启动训练失败",
      startUnconfirmed: "Spartan 无法确认训练是否已开始。正在后台检查状态。",
      stopFailed: "停止训练失败",
