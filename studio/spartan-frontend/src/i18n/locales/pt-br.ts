...
export const ptBR = {
  picker: {
    selectModel: "Selecionar modelo", invalidModel: "O modelo selecionado não é válido.", modelLoadFailed: "Não foi possível carregar o modelo", modelLoadFailedDescription: "Não foi possível carregar o modelo.",
  ...
  settings: {
    ...
    dialog: {
      title: "Configurações",
      description: "Gerencie suas preferências do Spartan.",
    ...
    debugging: {
      ...
      disabled: "O log em arquivo está desativado (SPARTAN_STUDIO_NO_FILE_LOG=1).",
    ...
    voice: {
      ...
      dictation: {
        ...
        sttLoaded: "Carregado",
        sttUnavailable:
          "Não instalado neste servidor. Execute `Spartan Studio update` para habilitar o ditado local.",
        ...
        micAccessBlocked:
          "O acesso ao microfone foi bloqueado. Permita o acesso ao microfone nesta página do Spartan e tente novamente.",
    ...
    general: {
      title: "Geral",
      description: "Preferências globais do Spartan.",
      account: "Conta",
      ...
      password: "Senha",
      passwordDescription: "Altere a senha desta conta do Spartan.",
      passwordDialog: {
        ...
        setDescription:
          "Escolha a senha que os navegadores remotos usam para entrar como Spartan (no mínimo {minLength} caracteres). O aplicativo de desktop da Spartan continua entrando automaticamente.",
      ...
      helperLlm: {
        ...
        disabledByEnv:
          "Desativado por SPARTAN_HELPER_MODEL_DISABLE no ambiente de backend.",
      ...
      modelAutoSwitch: {
        ...
        idleActiveViaEnv: "Ativo por meio de SPARTAN_MODEL_IDLE_TTL.",
      ...
      startup: {
        ...
        launchAtLogin: "Executar o Spartan ao fazer login",
        launchAtLoginDescription:
          "Inicia o Spartan em segundo plano quando você faz login. Ele permanece na barra de menus ou na bandeja do sistema até você abri-lo.",

        closeToTray: "Fechar para a bandeja do sistema",
        closeToTrayDescription:
          "Mantém o Spartan e seu servidor em execução em segundo plano ao fechar a janela principal.",
      ...
      resetPreferences: {
        ...
        confirmDescription:
          "Limpa as preferências locais e recarrega o Spartan. Chats, acesso à API e configurações salvas no banco de dados são mantidos.",
      ...
      permissions: {
        ...
        bypassDescription:
          "Como o Spartan aprova as chamadas de ferramentas do chat (terminal, python, web, MCP) antes de executá-las. O modo “Full access” desativa as aprovações e o sandbox de código.",
      },
    },
    profile: {
      title: "Perfil",
      description: "Como seu perfil aparece no Spartan.",
      changePicture: "Alterar foto de perfil",
      displayName: "Nome de exibição",
      nickname: "Como o Spartan deve chamar você?",
      ...
      stats: {
        ...
        subtitle:
          "Tudo abaixo é calculado a partir do seu próprio histórico. Nada é coletado nem enviado ao Spartan.",
        retry: "Tentar novamente",
        privacyNote:
          "As estatísticas são calculadas a partir do histórico de chats e de treinos guardado pela sua instalação do Spartan. Nada é coletado e nada é enviado ao Spartan ou a terceiros.",
        emptyChats:
    ...
    appearance: {
      title: "Aparência",
      description: "A aparência do Spartan neste dispositivo.",
      theme: {
        title: "Tema",
      ...
      palette: {
        ...
        description: "Cores usadas no Spartan, nos modos claro e escuro.",
        standard: "Padrão",
        classic: "Clássico",
        minimal: "Minimalista",
      },
      custom: {
        ...
        uiFontSize: {
          ...
          description: "Ajuste o tamanho base da interface do Spartan.",
        },
        codeFontSize: {
      ...
      language: {
        ...
        description: "O idioma utilizado pelo Spartan.",
    ...
    resources: {
      title: "Sistema",
      description: "Monitore o hardware e o armazenamento deste servidor Spartan.",
      ...
      llamaBackend: {
        ...
        customPath: {
          ...
          bundled: "Usa o runtime llama.cpp instalado pelo Spartan.",
    ...
    agents: {
      title: "Agentes",
      description:
        "Conecte agentes de código como Claude Code e Codex a um modelo local com Spartan start.",
      intro:
        "conecta Claude Code, Codex, Hermes, OpenClaw, OpenCode e outros agentes a um modelo servido localmente pelo Spartan, totalmente offline. Ele executa um servidor compatível com a API da OpenAI e nunca altera os arquivos de configuração do seu agente.",
      ...
      modelNote:
        "O Codex exige um modelo GGUF servido pelo llama-server. Outros agentes também podem usar modelos baseados em transformers; remova --model para usar o modelo já carregado no Spartan.",
      subagent: {
        title: "Usar um modelo local como subagente",
        description:
          "Mantenha o {agent} no modelo atual e delegue tarefas selecionadas a este modelo local do Spartan.",
        ...
        opencodePrompt: "@Spartan encontre a causa desta falha de teste",
      },
      quickstart: {
      ...
      options: {
        title: "Opções comuns",
        description:
          "As flags do Spartan são interpretadas primeiro; tudo o que ele não reconhecer é repassado direto ao agente.",
        model:
          "Seleciona um modelo. Sem --model, o Spartan start usa o modelo carregado no Studio e retorna erro se não houver nenhum.",
        contextLength:
        ...
        persist:
          "Mantém entre execuções o armazenamento de agentes gerenciado pelo Spartan.",
        asSubagent:
          "Mantém o agente principal no modelo atual e registra o Spartan como subagente local (Claude Code, Codex e OpenCode).",
        apiKey:
          "Informa sua chave de API do Spartan (ou defina SPARTAN_API_KEY).",
        yolo: "Pula os pedidos de aprovação. Use apenas em ambientes confiáveis.",
      },
      remote: {
        title: "Conectar a um Studio remoto",
        description:
          "Aponte o Spartan start para um Studio em execução em outro lugar, definindo estas variáveis antes de iniciar (ou passe --api-key diretamente):",
      },
      passthrough: {
        title: "Repassar argumentos ao agente",
        description:
          "Os argumentos após as flags do Spartan são encaminhados ao próprio agente, então comandos nativos como resume continuam funcionando:",
      },
      dryRun: {
    ...
    apiKeys: {
      title: "API",
      description:
        "Acesse o Spartan por meio da API compatível com OpenAI.",
      ...
      secureHttpsHint:
        "O endereço 0.0.0.0 ainda está acessível globalmente. Para segurança total, inicie o Spartan com --secure para expor apenas este link HTTPS.",
    ...
    about: {
      ...
      studioVersion: "Versão do Spartan",
      ...
      shutDownStudio: "Desligar o Spartan",
      shutDownStudioDescription:
        "Interrompe o servidor Spartan e encerra sua sessão.",
      shutDown: "Desligar",
      update: {
        title: "Atualizar Spartan",
        commandText: "Texto de {label}",
        copied: "Copiado",
        copyCommand: "Copiar comando",
        commandCopied: "{label} copiado",
        copyNamedCommand: "Copiar {label}",
        checkingInstall: "Verificando como o Spartan foi instalado...",
        installIntro: "Para instalar ou atualizar o Spartan:",
        ...
        restartAfterUpdate: "Reinicie o Spartan após a atualização.",
        desktopManaged:
        ...
        desktopExternalServer:
          "Execute `Spartan Studio update` no terminal usado para iniciar o servidor.",
        ...
        desktopCurrentDescription:
          "O Spartan continuará verificando automaticamente.",
        ...
        unknownInstall:
          "Não foi possível detectar como o Spartan foi instalado. Para instalações via instalador ou PyPI, use os comandos acima.",
        localCheckout:
  ...
  studio: {
    ...
    training: {
      ...
      startUnconfirmed:
        "O Spartan não conseguiu confirmar se o treinamento foi iniciado. O status está sendo verificado em segundo plano.",
    ...
    trainingStart: {
      ...
      terminalStart: "> treinamento do Spartan iniciado...",
