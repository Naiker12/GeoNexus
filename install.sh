...
#
# A piped install takes options as environment variables after the pipe (SPARTAN_NO_TORCH,
# SPARTAN_SKIP_AUTOSTART, SPARTAN_PYTHON, SPARTAN_STUDIO_HOME); a local run takes the equivalent flags
